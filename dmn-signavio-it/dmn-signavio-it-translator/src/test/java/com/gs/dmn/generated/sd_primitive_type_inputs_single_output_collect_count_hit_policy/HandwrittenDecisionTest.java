...
public class HandwrittenDecisionTest extends AbstractHandwrittenDecisionTest {
    ...
    public void testApply() {
        assertEquals(4, applyDecision("1", "1").intValue());
        assertEquals(2, applyDecision("1", null).intValue());
        assertEquals(2, applyDecision(null, "1").intValue());
        assertEquals(1, applyDecision(null, null).intValue());
    }
    ...
    private Number applyDecision(String numberInput, String textInput) {
