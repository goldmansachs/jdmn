...
public class HandwrittenDecisionTest extends AbstractHandwrittenDecisionTest {
    ...
    public void testApply() {
        assertEquals(1, decision.apply("1", "1", annotationSet, eventListener, externalFunctionExecutor, cache).intValue());
        assertEquals(2, decision.apply("1", null, annotationSet, eventListener, externalFunctionExecutor, cache).intValue());
        assertEquals(3, decision.apply((String)null, "1", annotationSet, eventListener, externalFunctionExecutor, cache).intValue());
