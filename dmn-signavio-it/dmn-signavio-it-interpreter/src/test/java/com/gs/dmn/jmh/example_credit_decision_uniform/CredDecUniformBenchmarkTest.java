 ...
 */
package com.gs.dmn.jmh.example_credit_decision_uniform;
...
public class CredDecUniformBenchmarkTest {
    private static final BuildLogger LOGGER = new Slf4jBuildLogger(LoggerFactory.getLogger(CredDecUniformBenchmarkTest.class));

    private static final DMNDialectDefinition dialectDefinition = new UniformJavaTimeSignavioDMNDialectDefinition();
    private static final DMNReader dmnReader = new DMNReader(LOGGER, false);
    private static final UniformJavaTimeSignavioLib decision = (UniformJavaTimeSignavioLib) dialectDefinition.createFEELLib();
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(CredDecUniformBenchmarkTest.class.getSimpleName())
                .warmupIterations(10)
