...
<#macro addEvaluateIterationMethod drgElement>
    protected ${transformer.drgElementOutputType(drgElement)} evaluate(${transformer.drgElementEvaluateSignature(drgElement)}) {
        ...
        <#assign lambdaBody = "${transformer.drgElementVariableName(topLevelDecision)}.apply(${transformer.drgElementArgumentsExtra(transformer.drgElementConvertedArgumentList(topLevelDecision))})" />
