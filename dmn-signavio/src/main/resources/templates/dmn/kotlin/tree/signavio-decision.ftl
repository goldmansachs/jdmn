...
<@metadata.classAnnotation "signavio-decision.ftl" drgElement/>class ${nativeClassName}(${transformer.drgElementConstructorSignature(drgElement)}) : ${decisionBaseClass}<${transformer.drgElementOutputType(drgElement)}>() {
