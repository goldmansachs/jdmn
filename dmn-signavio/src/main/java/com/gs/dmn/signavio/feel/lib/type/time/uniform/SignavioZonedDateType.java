...
public class SignavioZonedDateType extends ZonedDateType implements DateType<ZonedDateTime, Duration> {
    public SignavioZonedDateType(Logger logger, DatatypeFactory datatypeFactory) {
