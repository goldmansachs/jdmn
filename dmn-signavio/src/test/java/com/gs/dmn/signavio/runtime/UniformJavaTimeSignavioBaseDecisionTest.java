...
public class UniformJavaTimeSignavioBaseDecisionTest {
    private final UniformJavaTimeSignavioBaseDecision baseDecision = new UniformJavaTimeSignavioBaseDecision();
