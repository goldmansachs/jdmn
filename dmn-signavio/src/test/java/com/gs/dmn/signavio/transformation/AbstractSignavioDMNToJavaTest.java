...
public abstract class AbstractSignavioDMNToJavaTest extends AbstractSignavioDMNToNativeTest<Number, LocalDate, TemporalAccessor, TemporalAccessor, TemporalAmount> {
    @Override
