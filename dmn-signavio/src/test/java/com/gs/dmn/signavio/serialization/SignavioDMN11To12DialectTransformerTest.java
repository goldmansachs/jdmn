...
public class SignavioDMN11To12DialectTransformerTest extends DMN11To12DialectTransformerTest {
    private static final String SIG_NAMESPACE = "http://www.provider.com/dmn/1.1/diagram/";
    private static final String SIG_EXT_NAMESPACE = "http://www.provider.com/schema/dmn/1.1/";
    ...
    public void testTransformWithDecisionService() throws Exception {
        doTest("simple-decision-with-bkm-clone.dmn", new Pair<>(SIG_NAMESPACE + "2521256910f54d44b0a90fa88a1aa917.xml", "sig"));
    }
