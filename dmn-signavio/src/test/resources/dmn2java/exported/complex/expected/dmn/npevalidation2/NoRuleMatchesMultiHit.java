...
@javax.annotation.Generated(value = {"decision-with-extension.ftl", "noRuleMatchesMultiHit"})
...
public class NoRuleMatchesMultiHit extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public List<Boolean> apply(String second, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
    ...
    public List<Boolean> apply(java.math.BigDecimal second, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            List<Boolean> output_ = evaluate(second, annotationSet_, eventListener_, externalExecutor_);
    ...
    protected List<Boolean> evaluate(java.math.BigDecimal second, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
    ...
    public com.gs.dmn.runtime.RuleOutput rule0(java.math.BigDecimal second, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        ...
        if (Boolean.TRUE == (numericEqual(second, number("1")))) {
            // Rule match
    ...
    public com.gs.dmn.runtime.RuleOutput rule1(java.math.BigDecimal second, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        ...
        // Apply rule
        NoRuleMatchesMultiHitRuleOutput output_ = new NoRuleMatchesMultiHitRuleOutput(false);
        if (Boolean.TRUE == (numericEqual(second, number("2")))) {
            // Rule match
            eventListener_.matchRule(DRG_ELEMENT_METADATA, drgRuleMetadata);
    ...
    public com.gs.dmn.runtime.RuleOutput rule2(java.math.BigDecimal second, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        ...
        // Apply rule
        NoRuleMatchesMultiHitRuleOutput output_ = new NoRuleMatchesMultiHitRuleOutput(false);
        if (Boolean.TRUE == (numericEqual(second, number("3")))) {
            // Rule match
            eventListener_.matchRule(DRG_ELEMENT_METADATA, drgRuleMetadata);
