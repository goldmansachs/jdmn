...
@javax.annotation.Generated(value = {"decision-with-extension.ftl", "stringHandlingComparator"})
...
public class StringHandlingComparator extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public Boolean apply(java.math.BigDecimal numberA, java.math.BigDecimal numberB, List<String> stringList, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            String stringHandling = this.stringHandling.apply(numberA, numberB, stringList, annotationSet_, eventListener_, externalExecutor_);

            // Evaluate decision 'stringHandlingComparator'
            Boolean output_ = evaluate(stringHandling, annotationSet_, eventListener_, externalExecutor_);
    ...
    protected Boolean evaluate(String stringHandling, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
