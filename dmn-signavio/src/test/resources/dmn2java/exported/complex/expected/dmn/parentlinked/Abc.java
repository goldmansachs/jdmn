...
@javax.annotation.Generated(value = {"decision-with-extension.ftl", "abc"})
...
public class Abc extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public java.math.BigDecimal apply(java.math.BigDecimal num, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            java.math.BigDecimal output_ = evaluate(num, annotationSet_, eventListener_, externalExecutor_);
    ...
    protected java.math.BigDecimal evaluate(java.math.BigDecimal num, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
