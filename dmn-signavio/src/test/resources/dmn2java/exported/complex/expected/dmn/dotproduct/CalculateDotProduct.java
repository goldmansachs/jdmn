...
@javax.annotation.Generated(value = {"decision-with-extension.ftl", "calculateDotProduct"})
...
public class CalculateDotProduct extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public java.math.BigDecimal apply(List<java.math.BigDecimal> a, List<java.math.BigDecimal> b, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            List<type.Componentwise> componentwise = this.componentwise.apply(a, b, annotationSet_, eventListener_, externalExecutor_);

            // Iterate and aggregate
            java.math.BigDecimal output_ = evaluate(a, b, componentwise, annotationSet_, eventListener_, externalExecutor_);
    ...
    protected java.math.BigDecimal evaluate(List<java.math.BigDecimal> a, List<java.math.BigDecimal> b, List<type.Componentwise> componentwise, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        ...
        return sum(componentwise.stream().map(componentwise4_iterator -> product.apply(type.Componentwise3.toComponentwise3(componentwise4_iterator), annotationSet_, eventListener_, externalExecutor_)).collect(Collectors.toList()));
    }
}
