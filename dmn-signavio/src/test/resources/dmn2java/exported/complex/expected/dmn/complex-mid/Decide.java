...
public class Decide extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public String apply(String properties_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        return apply(properties_iterator, annotationSet_, new com.gs.dmn.runtime.listener.LoggingEventListener(LOGGER), new com.gs.dmn.runtime.external.DefaultExternalFunctionExecutor());
    }

    public String apply(String properties_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            String output_ = evaluate(properties_iterator, annotationSet_, eventListener_, externalExecutor_);
    ...
    protected String evaluate(String properties_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
    ...
    public com.gs.dmn.runtime.RuleOutput rule0(String properties_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        ...
        if (Boolean.TRUE == booleanOr((stringEqual(properties_iterator, "Happy")), (stringEqual(properties_iterator, "Tall")), (stringEqual(properties_iterator, "Quiet")))) {
            // Rule match
    ...
    public com.gs.dmn.runtime.RuleOutput rule1(String properties_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        ...
        // Apply rule
        DecideRuleOutput output_ = new DecideRuleOutput(false);
        if (Boolean.TRUE == booleanOr((stringEqual(properties_iterator, "Sad")), (stringEqual(properties_iterator, "Short")), (stringEqual(properties_iterator, "Loud")))) {
            // Rule match
            eventListener_.matchRule(DRG_ELEMENT_METADATA, drgRuleMetadata);
    ...
    public com.gs.dmn.runtime.RuleOutput rule2(String properties_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        ...
        // Apply rule
        DecideRuleOutput output_ = new DecideRuleOutput(false);
        if (Boolean.TRUE == booleanNot(booleanOr((stringEqual(properties_iterator, "Happy")), (stringEqual(properties_iterator, "Sad")), (stringEqual(properties_iterator, "Tall")), (stringEqual(properties_iterator, "Short")), (stringEqual(properties_iterator, "Loud")), (stringEqual(properties_iterator, "Quiet"))))) {
            // Rule match
            eventListener_.matchRule(DRG_ELEMENT_METADATA, drgRuleMetadata);
    ...
    public com.gs.dmn.runtime.RuleOutput rule3(String properties_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        ...
        // Apply rule
        DecideRuleOutput output_ = new DecideRuleOutput(false);
        if (Boolean.TRUE == (properties_iterator == null)) {
            // Rule match
            eventListener_.matchRule(DRG_ELEMENT_METADATA, drgRuleMetadata);
