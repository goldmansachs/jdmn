...
public class Decision extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public String apply(String testPersonType6_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        try {
    ...
    public String apply(String testPersonType6_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
    ...
    public String apply(type.TestPersonType testPersonType6_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
    ...
    public String apply(type.TestPersonType testPersonType6_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            decisionArguments_.put("testPersonType6_iterator", testPersonType6_iterator);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decisionArguments_);

            // Evaluate decision 'decision'
            String output_ = evaluate(testPersonType6_iterator, annotationSet_, eventListener_, externalExecutor_);
    ...
    protected String evaluate(type.TestPersonType testPersonType6_iterator, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
