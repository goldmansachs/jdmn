...
@javax.annotation.Generated(value = {"decision-with-extension.ftl", "addExtraValues"})
...
public class AddExtraValues extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public List<java.math.BigDecimal> apply(List<java.math.BigDecimal> listOfNumbers, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            List<java.math.BigDecimal> output_ = evaluate(listOfNumbers, annotationSet_, eventListener_, externalExecutor_);
    ...
    protected List<java.math.BigDecimal> evaluate(List<java.math.BigDecimal> listOfNumbers, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
