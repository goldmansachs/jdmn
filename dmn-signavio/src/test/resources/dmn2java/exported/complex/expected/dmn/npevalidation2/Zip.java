...
public class Zip extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public List<type.Zip> apply(String ages, String day, String hour, String minute, String month, String names, String second, String year, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        try {
            return apply((ages != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(ages, java.math.BigDecimal[].class)) : null), (day != null ? number(day) : null), (hour != null ? number(hour) : null), (minute != null ? number(minute) : null), (month != null ? number(month) : null), (names != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(names, String[].class)) : null), (second != null ? number(second) : null), (year != null ? number(year) : null), annotationSet_, new com.gs.dmn.runtime.listener.LoggingEventListener(LOGGER), new com.gs.dmn.runtime.external.DefaultExternalFunctionExecutor());
        } catch (Exception e) {
    ...
    public List<type.Zip> apply(String ages, String day, String hour, String minute, String month, String names, String second, String year, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            return apply((ages != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(ages, java.math.BigDecimal[].class)) : null), (day != null ? number(day) : null), (hour != null ? number(hour) : null), (minute != null ? number(minute) : null), (month != null ? number(month) : null), (names != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(names, String[].class)) : null), (second != null ? number(second) : null), (year != null ? number(year) : null), annotationSet_, eventListener_, externalExecutor_);
        } catch (Exception e) {
            logError("Cannot apply decision 'Zip'", e);
            return null;
        }
    ...
    public List<type.Zip> apply(List<java.math.BigDecimal> ages, java.math.BigDecimal day, java.math.BigDecimal hour, java.math.BigDecimal minute, java.math.BigDecimal month, List<String> names, java.math.BigDecimal second, java.math.BigDecimal year, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        return apply(ages, day, hour, minute, month, names, second, year, annotationSet_, new com.gs.dmn.runtime.listener.LoggingEventListener(LOGGER), new com.gs.dmn.runtime.external.DefaultExternalFunctionExecutor());
    }
    ...
    public List<type.Zip> apply(List<java.math.BigDecimal> ages, java.math.BigDecimal day, java.math.BigDecimal hour, java.math.BigDecimal minute, java.math.BigDecimal month, List<String> names, java.math.BigDecimal second, java.math.BigDecimal year, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            List<java.math.BigDecimal> accessCertainTemporalUnits = this.accessCertainTemporalUnits.apply(day, hour, minute, month, second, year, annotationSet_, eventListener_, externalExecutor_);
            Boolean buildDateStringInAnnotation = this.buildDateStringInAnnotation.apply(day, month, year, annotationSet_, eventListener_, externalExecutor_);
            List<String> describeAgesList = this.describeAgesList.apply(ages, annotationSet_, eventListener_, externalExecutor_);
            java.math.BigDecimal negateSecond = this.negateSecond.apply(second, annotationSet_, eventListener_, externalExecutor_);
            List<Boolean> noRuleMatchesMultiHit = this.noRuleMatchesMultiHit.apply(second, annotationSet_, eventListener_, externalExecutor_);
            Boolean noRuleMatchesSingleHit = this.noRuleMatchesSingleHit.apply(second, annotationSet_, eventListener_, externalExecutor_);
            List<type.TemporalDiffs> temporalDiffs = this.temporalDiffs.apply(day, hour, minute, month, second, year, annotationSet_, eventListener_, externalExecutor_);

            // Evaluate decision 'zip'
            List<type.Zip> output_ = evaluate(accessCertainTemporalUnits, ages, buildDateStringInAnnotation, describeAgesList, names, negateSecond, noRuleMatchesMultiHit, noRuleMatchesSingleHit, temporalDiffs, annotationSet_, eventListener_, externalExecutor_);
