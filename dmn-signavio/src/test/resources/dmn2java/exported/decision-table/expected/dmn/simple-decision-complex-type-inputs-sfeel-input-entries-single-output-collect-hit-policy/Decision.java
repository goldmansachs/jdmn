...
public class Decision extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public List<String> apply(String employed, String person, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        try {
            return apply((employed != null ? Boolean.valueOf(employed) : null), (person != null ? com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(person, type.PersonImpl.class) : null), annotationSet_, new com.gs.dmn.runtime.listener.LoggingEventListener(LOGGER), new com.gs.dmn.runtime.external.DefaultExternalFunctionExecutor());
        } catch (Exception e) {
    ...
    public List<String> apply(String employed, String person, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            return apply((employed != null ? Boolean.valueOf(employed) : null), (person != null ? com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(person, type.PersonImpl.class) : null), annotationSet_, eventListener_, externalExecutor_);
        } catch (Exception e) {
            logError("Cannot apply decision 'Decision'", e);
            return null;
        }
