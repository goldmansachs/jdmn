...
public class Decision extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    public String apply(String booleanInput, String dateAndTimeInput, String dateInput, String enumerationInput, String numberInput, String textInput, String timeInput, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        try {
            return apply((booleanInput != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(booleanInput, Boolean[].class)) : null), (dateAndTimeInput != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(dateAndTimeInput, javax.xml.datatype.XMLGregorianCalendar[].class)) : null), (dateInput != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(dateInput, javax.xml.datatype.XMLGregorianCalendar[].class)) : null), (enumerationInput != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(enumerationInput, String[].class)) : null), (numberInput != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(numberInput, java.math.BigDecimal[].class)) : null), (textInput != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(textInput, String[].class)) : null), (timeInput != null ? asList(com.gs.dmn.serialization.JsonSerializer.OBJECT_MAPPER.readValue(timeInput, javax.xml.datatype.XMLGregorianCalendar[].class)) : null), annotationSet_, new com.gs.dmn.runtime.listener.LoggingEventListener(LOGGER), new com.gs.dmn.runtime.external.DefaultExternalFunctionExecutor());
        } catch (Exception e) {
