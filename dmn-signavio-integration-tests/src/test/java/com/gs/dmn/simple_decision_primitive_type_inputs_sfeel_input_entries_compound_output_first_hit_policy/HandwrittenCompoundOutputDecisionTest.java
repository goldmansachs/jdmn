 ...
 */
package com.gs.dmn.simple_decision_primitive_type_inputs_sfeel_input_entries_compound_output_first_hit_policy;
...
public class HandwrittenCompoundOutputDecisionTest extends AbstractHandwrittenDecisionTest {
    ...
    public void testApplyWhenRule0() {
        com.gs.dmn.simple_decision_primitive_type_inputs_sfeel_input_entries_compound_output_first_hit_policy.type.CompoundOutputDecision output = applyDecision("true", "2016-08-01T11:00:00Z", "2016-08-01", "e1", "-1", "abc", "12:00:00Z");
        assertEquals("r11", output.getFirstOutput());
        assertEquals("r12", output.getSecondOutput());
    }

    private com.gs.dmn.simple_decision_primitive_type_inputs_sfeel_input_entries_compound_output_first_hit_policy.type.CompoundOutputDecision applyDecision(
