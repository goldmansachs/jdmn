package com.gs.dmn.type_interface_deserialization;
...
public class HandwrittenDecisionTest extends AbstractHandwrittenDecisionTest {
    ...
    public void testDeserializedDecisionInput() throws Exception {
        ...
        com.gs.dmn.type_interface_deserialization.type.MarginEquityOptionTradableProfiles marginEquityOptionTradableProfiles = new com.gs.dmn.type_interface_deserialization.type.MarginEquityOptionTradableProfilesImpl(decision.asList(new com.gs.dmn.type_interface_deserialization.type.MarginEquityOptionTradableProfileImpl(Boolean.TRUE, "abc")));
