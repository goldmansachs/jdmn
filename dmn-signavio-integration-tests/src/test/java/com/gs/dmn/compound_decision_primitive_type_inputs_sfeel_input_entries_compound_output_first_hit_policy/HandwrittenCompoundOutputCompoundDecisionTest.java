 ...
 */
package com.gs.dmn.compound_decision_primitive_type_inputs_sfeel_input_entries_compound_output_first_hit_policy;
...
public class HandwrittenCompoundOutputCompoundDecisionTest extends AbstractHandwrittenDecisionTest {
    ...
    private void check(String booleanInput, String enumerationInput, String numberInput, String textInput, String expectedFirstOutput, String expectedSecondOutput) {
        ...
        com.gs.dmn.compound_decision_primitive_type_inputs_sfeel_input_entries_compound_output_first_hit_policy.type.CompoundOutputCompoundDecision output = decision.apply(booleanInput, textInput, numberInput, enumerationInput, annotationSet);
