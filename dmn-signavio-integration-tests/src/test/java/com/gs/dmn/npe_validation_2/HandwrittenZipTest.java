 ...
 */
package com.gs.dmn.npe_validation_2;
...
public class HandwrittenZipTest extends AbstractHandwrittenDecisionTest {
    ...
    public void testCase1() {
        ...
        List<com.gs.dmn.npe_validation_2.type.Zip> expectedOutput = decision.asList(new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("25"), "not exactly 1 to 5", decision.number("0"), decision.number("0"), "Fred", decision.number("12")), new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("40"), "non of the numbers 1 to 5", decision.number("0"), decision.number("0"), "Jim", decision.number("2016")), new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("65"), null, decision.number("0"), decision.number("0"), "Tom", decision.number("7")), new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("80"), null, decision.numericUnaryMinus(decision.number("359")), decision.numericUnaryMinus(decision.number("8612")), "Sarah", decision.number("25")), new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("105"), null, null, null, "Kate", decision.number("5")));
    ...
    public void testCase2() {
        ...
        List<com.gs.dmn.npe_validation_2.type.Zip> expectedOutput = decision.asList(new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("3"), "not exactly 1 to 5", decision.number("0"), decision.number("0"), "John", decision.number("2")), new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("4"), "only numbers between 1 and 5", decision.number("0"), decision.number("0"), "Amy", decision.number("3")), new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("5"), "at least one number betwen 1 and 5", decision.number("0"), decision.number("0"), "Tim", decision.number("6")), new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("2"), "only numbers between 1 and 5", decision.number("735202"), decision.number("17644858"), "James", decision.number("1")), new com.gs.dmn.npe_validation_2.type.ZipImpl(decision.number("1"), null, null, null, "Ewa", decision.number("2")));
        checkValues(expectedOutput, zipOutput);
    }
