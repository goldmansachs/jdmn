 ...
 */
package com.gs.dmn.example_credit_decision_mixed_dag;

import com.gs.dmn.AbstractHandwrittenDecisionTest;
import com.gs.dmn.example_credit_decision_mixed_dag.type.Applicant;
import com.gs.dmn.example_credit_decision_mixed_dag.type.ApplicantImpl;
...
public class HandwrittenGenerateOutputDataTest extends AbstractHandwrittenDecisionTest {
    ...
    public void testCase1() {
        ...
        com.gs.dmn.example_credit_decision_mixed_dag.type.Applicant applicant = new ApplicantImpl(decision.number("38"), decision.number("100"), "Amy", decision.asList("Late payment"));
        ...
        List<com.gs.dmn.example_credit_decision.type.GenerateOutputData> expected = decision.asList(new com.gs.dmn.example_credit_decision.type.GenerateOutputDataImpl(decision.number("27.5"), "Accept", decision.numericUnaryMinus(decision.number("7.5"))));
    ...
    public void testCase2() {
        ...
        List<com.gs.dmn.example_credit_decision.type.GenerateOutputData> expected = decision.asList(new com.gs.dmn.example_credit_decision.type.GenerateOutputDataImpl(decision.numericUnaryMinus(decision.number("10")), "Reject", decision.numericUnaryMinus(decision.number("25"))));
    ...
    public void testCase3() {
        ...
        List<com.gs.dmn.example_credit_decision.type.GenerateOutputData> expected = decision.asList(new com.gs.dmn.example_credit_decision.type.GenerateOutputDataImpl(decision.numericUnaryMinus(decision.number("42.5")), "Reject", decision.numericUnaryMinus(decision.number("77.5"))));
        checkValues(expected, generateOutputDataOutput);
    }
