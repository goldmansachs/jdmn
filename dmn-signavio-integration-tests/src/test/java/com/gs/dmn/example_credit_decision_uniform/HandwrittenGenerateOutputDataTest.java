 ...
 */
package com.gs.dmn.example_credit_decision_uniform;

import com.gs.dmn.AbstractHandwrittenDecisionTest;
import com.gs.dmn.example_credit_decision_uniform.type.Applicant;
import com.gs.dmn.example_credit_decision_uniform.type.ApplicantImpl;
...
public class HandwrittenGenerateOutputDataTest extends AbstractHandwrittenDecisionTest {
    ...
    public void testCase1() {
        ...
        List<com.gs.dmn.example_credit_decision_uniform.type.GenerateOutputData> expected = decision.asList(new com.gs.dmn.example_credit_decision_uniform.type.GenerateOutputDataImpl(decision.number("27.5"), "Accept", decision.numericUnaryMinus(decision.number("7.5"))));
    ...
    public void testCase2() {
        ...
        List<com.gs.dmn.example_credit_decision_uniform.type.GenerateOutputData> expected = decision.asList(new com.gs.dmn.example_credit_decision_uniform.type.GenerateOutputDataImpl(decision.numericUnaryMinus(decision.number("10")), "Reject", decision.numericUnaryMinus(decision.number("25"))));
    ...
    public void testCase3() {
        ...
        List<com.gs.dmn.example_credit_decision_uniform.type.GenerateOutputData> expected = decision.asList(new com.gs.dmn.example_credit_decision_uniform.type.GenerateOutputDataImpl(decision.numericUnaryMinus(decision.number("42.5")), "Reject", decision.numericUnaryMinus(decision.number("77.5"))));
        checkValues(expected, generateOutputDataOutput);
    }
