...
public class Person {
    public static Person convert(Object other) {
        if (Person.class.isAssignableFrom(other.getClass())) {
            ...
            result_.setDateOfBirth((ZonedDateTime)((com.gs.dmn.runtime.Context)other).get("dateOfBirth"));
            result_.setTimeOfBirth((ZonedDateTime)((com.gs.dmn.runtime.Context)other).get("timeOfBirth"));
    ...
    public Person(ZonedDateTime dateOfBirth, ZonedDateTime dateTimeOfBirth, String firstName, String gender, java.math.BigDecimal id, String lastName, List<String> list, Boolean married, ZonedDateTime timeOfBirth) {
