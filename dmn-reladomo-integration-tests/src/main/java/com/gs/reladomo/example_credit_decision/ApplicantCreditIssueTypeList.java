...
public class ApplicantCreditIssueTypeList extends ApplicantCreditIssueTypeListAbstract
{
	...
	public ApplicantCreditIssueTypeList(int initialSize)
	{
		super(initialSize);
	}

	public ApplicantCreditIssueTypeList(Collection c)
	{
		super(c);
	}

	public ApplicantCreditIssueTypeList(Operation operation)
	{
		super(operation);
	}
}
