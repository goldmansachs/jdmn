...
public class DMNModellingStyleValidatorTest extends AbstractValidatorTest {
    ...
    public void testValidateWhenIncorrect() {
        List<String> expectedErrors = List.of(
                ...
                "[WARNING] (namespace = 'http://test.example.com/test-dmn-modelling-style', modelName = 'test-dmn-modelling-style', modelId = 'test-dmn-modelling-style', elementName = 'DecisionTable'): Expected at most one annotation clause, found 2.",
                "[WARNING] (namespace = 'http://test.example.com/test-dmn-modelling-style', modelName = 'test-dmn-modelling-style', modelId = 'test-dmn-modelling-style', elementName = 'DecisionTable'): Expected at most one annotation entry in rule 1, found 2.",
    ...
    public void testValidateNamesWhenIncorrect() {
        ...
        "[WARNING] (namespace = 'http://test.example.com/test-dmn-modelling-style-names', modelName = 'test-dmn-modelling-style-names ', modelId = 'test-dmn-modelling-style-names'): TypeRef 'prefix1.prefix2.string' contains more than one prefix separated by .",
        ...
        "[WARNING] (namespace = 'http://test.example.com/test-dmn-modelling-style-names', modelName = 'test-dmn-modelling-style-names ', modelId = 'test-dmn-modelling-style-names'): Model 'prefix1' is used but not imported in model 'http://test.example.com/test-dmn-modelling-style-names'.",
