...
class CyclicInformationRequirementsValidatorTest extends AbstractValidatorTest {
    private final CyclicInformationRequirementsValidator validator = new CyclicInformationRequirementsValidator();
