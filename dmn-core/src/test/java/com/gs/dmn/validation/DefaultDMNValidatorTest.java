...
public class DefaultDMNValidatorTest extends AbstractValidatorTest {
    ...
    public void testValidateDefinitionsWithError() {
        List<String> expectedErrors = List.of(
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions', elementName = 'dec1'): The name 'dec1' of the import is already used by a DRGElement",
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions', elementName = 'test-empty-container'): The name 'test-empty-container' of the import is already used by a top level ItemDefinition",
            ...
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions', elementName = 'test-empty-container'): Missing importType of import",
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions', elementName = 'test-empty-container'): Missing namespace of import",
            ...
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions'): Missing variable",
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions'): DecisionService 'null' must have at least 1 output decisions",
            ...
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions', elementId = 'ds'): DecisionService 'null' must have at least 1 output decisions",
            ...
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions', elementName = 'bkm2', elementId = 'bkm-params'): DRGElement name and variable name should be the same. Found 'bkm2' and 'bkmVar'",
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions', elementName = 'paramMissingType', elementId = 'paramMissingType'): Missing typeRef for parameter 'paramMissingType' in BusinessKnowledgeModel 'bkm2'",
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions', elementName = 'paramUnknownType', elementId = 'paramUnknownType'): Missing typeRef for parameter 'paramUnknownType' in BusinessKnowledgeModel 'bkm2'",
            "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-dmn', modelId = 'definitions'): Missing typeRef for body in BusinessKnowledgeModel 'bkm2'",
    ...
    public void testValidateBoxedExpressions() {
        List<String> expectedErrors = List.of(
                ...
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'def', elementId = 'def'): Missing typeRef in formal parameter 1",
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'def', elementId = 'def'): Missing name in formal parameter 2",
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'def', elementId = 'def'): Missing typeRef in formal parameter 2",
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'dt1', elementId = 'dt1'): Missing output clauses",
                ...
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'dt3', elementId = 'dt3'): Missing output clauses",
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'dt3', elementId = 'dt3'): The number of input entries in rule 1 does not match the number of input clauses in decision table 'dt3Table'. Expected 0 found 1.",
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'dt3', elementId = 'dt3'): The number of output entries in rule 1 does not match the number of output clauses in decision table 'dt3Table'. Expected 0 found 1.",
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'dt3', elementId = 'dt3'): The number of annotation entries in rule 1 exceeds the number of annotation clauses in decision table 'dt3Table'. Expected at most 0 found 1.",
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'emptyRel', elementId = 'emptyRel'): Empty relation",
