...
public class DefaultDMNValidatorTest extends AbstractValidatorTest {
    ...
    public void testValidateBoxedExpressions() {
        List<String> expectedErrors = List.of(
                ...
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'dt3', elementId = 'dt3'): The number of input entries in rule 1 does not match the number of input clauses in decision table dt3Table",
                "[ERROR] (namespace = 'http://example.org/dmn', modelName = 'test-boxed-expressions', modelId = 'definitions', elementName = 'dt3', elementId = 'dt3'): The number of output entries in rule 1 does not match the number of output clauses in decision table dt3Table",
