...
class CyclicKnowledgeRequirementsValidatorTest extends AbstractValidatorTest {
    private final CyclicKnowledgeRequirementsValidator validator = new CyclicKnowledgeRequirementsValidator();
