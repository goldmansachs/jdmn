...
public abstract class AbstractCL2SDMNInterpreterTest<NUMBER, DATE, TIME, DATE_TIME, DURATION> extends AbstractDMNInterpreterTest<NUMBER, DATE, TIME, DATE_TIME, DURATION> {
    ...
    public void test_11_cl2_0001_input_data_string() {
        doFolderTest("1.1", "0001-input-data-string");
    }

    @Test
    public void test_11_cl2_0002_input_data_number() {
        doFolderTest("1.1", "0002-input-data-number");
    }

    @Test
    public void test_11_cl2_0003_input_data_string_allowed_values() {
        doFolderTest("1.1", "0003-input-data-string-allowed-values");
    }
