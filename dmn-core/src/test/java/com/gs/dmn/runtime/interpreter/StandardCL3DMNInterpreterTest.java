...
public class StandardCL3DMNInterpreterTest extends AbstractCL3DMNInterpreterTest<BigDecimal, XMLGregorianCalendar, XMLGregorianCalendar, XMLGregorianCalendar, Duration> {
    @Override
