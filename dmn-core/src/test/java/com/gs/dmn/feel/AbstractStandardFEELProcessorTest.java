...
public abstract class AbstractStandardFEELProcessorTest<NUMBER, DATE, TIME, DATE_TIME, DURATION> extends AbstractFEELProcessorTest<NUMBER, DATE, TIME, DATE_TIME, DURATION, TestCases> {
    ...
    public void testFunctionInvocation() {
        ...
        doExpressionTest(entries, "", sort2,
                ...
                "ListType(number)",
                "sort(asList(score5, score6, score7, score8), new com.gs.dmn.runtime.LambdaExpression<Boolean>() {public Boolean apply(Object... args_) {"+numberType()+" x = ("+numberType()+")args_[0]; "+numberType()+" y = ("+numberType()+")args_[1];return numericLessThan(y, x);}})",
        ...
        doExpressionTest(entries, "", sublist2,
                ...
                "ListType(number)",
                "sublist(sort(asList(score5, score6, score7, score8), new com.gs.dmn.runtime.LambdaExpression<Boolean>() {public Boolean apply(Object... args_) {"+numberType()+" x = ("+numberType()+")args_[0]; "+numberType()+" y = ("+numberType()+")args_[1];return numericLessThan(y, x);}}), number(\"1\"), number(\"2\"))",
...
//                this.lib.duration("P1DT2H3M3S"));
    ...
    public void testListFunctions() {
        ...
        doExpressionTest(entries, "", "sort([1, 2, 3, 4], function(x: number, y: number) y < x)",
                ...
                "ListType(number)",
                "sort(asList(number(\"1\"), number(\"2\"), number(\"3\"), number(\"4\")), new com.gs.dmn.runtime.LambdaExpression<Boolean>() {public Boolean apply(Object... args_) {"+numberType()+" x = ("+numberType()+")args_[0]; "+numberType()+" y = ("+numberType()+")args_[1];return numericLessThan(y, x);}})",
    ...
    public void testInstanceOfExpression() {
        ...
        doExpressionTest(entries, "", "3 instance of number",
                ...
                "boolean",
                "isInstanceOf(number(\"3\"), new com.gs.dmn.feel.lib.reference.TypeReference(\"number\"))",
                this.lib.isInstanceOf(lib.number("3"), new com.gs.dmn.feel.lib.reference.TypeReference("number")),
                true);
        doExpressionTest(entries, "", "\"abc\" instance of string",
                "InstanceOfExpression(StringLiteral(\"abc\"), NamedTypeExpression(string))",
                "boolean",
                "isInstanceOf(\"abc\", new com.gs.dmn.feel.lib.reference.TypeReference(\"string\"))",
                lib.isInstanceOf("abc", new com.gs.dmn.feel.lib.reference.TypeReference("string")),
                true);
        doExpressionTest(entries, "", "true instance of boolean",
                "InstanceOfExpression(BooleanLiteral(true), NamedTypeExpression(boolean))",
                "boolean",
                "isInstanceOf(Boolean.TRUE, new com.gs.dmn.feel.lib.reference.TypeReference(\"boolean\"))",
                lib.isInstanceOf(Boolean.TRUE, new com.gs.dmn.feel.lib.reference.TypeReference("boolean")),
                true);
        doExpressionTest(entries, "", "date(\"2011-01-03\") instance of date",
                ...
                "boolean",
                "isInstanceOf(date(\"2011-01-03\"), new com.gs.dmn.feel.lib.reference.TypeReference(\"date\"))",
                this.lib.isInstanceOf(lib.date("2011-01-03"), new com.gs.dmn.feel.lib.reference.TypeReference("date")),
                true);
        doExpressionTest(entries, "", "time(\"12:00:00Z\") instance of time",
                ...
                "boolean",
                "isInstanceOf(time(\"12:00:00Z\"), new com.gs.dmn.feel.lib.reference.TypeReference(\"time\"))",
                this.lib.isInstanceOf(lib.time("12:00:00Z"), new com.gs.dmn.feel.lib.reference.TypeReference("time")),
                true);
        doExpressionTest(entries, "", "date and time(\"2016-03-01T12:00:00Z\") instance of date and time",
                ...
                "boolean",
                "isInstanceOf(dateAndTime(\"2016-03-01T12:00:00Z\"), new com.gs.dmn.feel.lib.reference.TypeReference(\"'date and time'\"))",
                this.lib.isInstanceOf(lib.dateAndTime("2016-03-01T12:00:00Z"), new com.gs.dmn.feel.lib.reference.TypeReference("'date and time'")),
                true);
        doExpressionTest(entries, "", "duration(\"P1Y1M\") instance of years and months duration",
                ...
                "boolean",
                "isInstanceOf(duration(\"P1Y1M\"), new com.gs.dmn.feel.lib.reference.TypeReference(\"'years and months duration'\"))",
                this.lib.isInstanceOf(lib.duration("P1Y1M"), new com.gs.dmn.feel.lib.reference.TypeReference("'years and months duration'")),
                true);
        doExpressionTest(entries, "", "duration(\"P1DT1H\") instance of days and time duration",
                ...
                "boolean",
                "isInstanceOf(duration(\"P1DT1H\"), new com.gs.dmn.feel.lib.reference.TypeReference(\"'days and time duration'\"))",
                this.lib.isInstanceOf(lib.duration("P1DT1H"), new com.gs.dmn.feel.lib.reference.TypeReference("'days and time duration'")),
                true);
        doExpressionTest(entries, "", "[1, 2, 3] instance of list<number>",
                ...
                "boolean",
                "isInstanceOf(asList(number(\"1\"), number(\"2\"), number(\"3\")), new com.gs.dmn.feel.lib.reference.TypeReference(\"list<number>\"))",
                this.lib.isInstanceOf(this.lib.asList(this.lib.number("1"), this.lib.number("2"), this.lib.number("3")), new com.gs.dmn.feel.lib.reference.TypeReference("list<number>")),
                true);
        doExpressionTest(entries, "", "{a: 1, b: \"2\"} instance of context<a: number, b: string>",
                ...
                "boolean",
                "isInstanceOf(new com.gs.dmn.runtime.Context().add(\"a\", number(\"1\")).add(\"b\", \"2\"), new com.gs.dmn.feel.lib.reference.TypeReference(\"context<a: number, b: string>\"))",
                this.lib.isInstanceOf(new com.gs.dmn.runtime.Context().add("a", this.lib.number("1")).add("b", "2"), new com.gs.dmn.feel.lib.reference.TypeReference("context<a: number, b: string>")),
                true);
        doExpressionTest(entries, "", "{\"a\": 1, \"b\": \"2\"} instance of context<a: number, b: string>",
                "InstanceOfExpression(Context(ContextEntry(ContextEntryKey(a) = NumericLiteral(1)),ContextEntry(ContextEntryKey(b) = StringLiteral(\"2\"))), ContextTypeExpression(a: NamedTypeExpression(number), b: NamedTypeExpression(string)))",
                "boolean",
        ...
        doExpressionTest(entries, "", "[1..3) instance of range<number>",
                ...
                "boolean",
                "isInstanceOf(new com.gs.dmn.runtime.Range<>(true, number(\"1\"), false, number(\"3\")), new com.gs.dmn.feel.lib.reference.TypeReference(\"range<number>\"))",
                this.lib.isInstanceOf(new com.gs.dmn.runtime.Range<>(true, this.lib.number("1"), false, this.lib.number("3")), new com.gs.dmn.feel.lib.reference.TypeReference("range<number>")),
                true);
        doExpressionTest(entries, "", "(function () 4) instance of function <> -> number",
                ...
                "boolean",
                "isInstanceOf(new com.gs.dmn.runtime.LambdaExpression<" + numberType() + ">() {public " + numberType() + " apply(Object... args_) {return number(\"4\");}}, new com.gs.dmn.feel.lib.reference.TypeReference(\"function<> -> number\"))",
                this.lib.isInstanceOf(new com.gs.dmn.runtime.LambdaExpression<NUMBER>() {public NUMBER apply(Object... args_) {return (NUMBER) lib.number("4");}}, new com.gs.dmn.feel.lib.reference.TypeReference("function<> -> number")),
                null);
