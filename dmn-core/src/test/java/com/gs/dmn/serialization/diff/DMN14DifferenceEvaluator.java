...
class DMN14DifferenceEvaluator extends XMLDifferenceEvaluator {
    @Override
    ...
    protected String safeStripDMNPrefix(Node target) {
        if (DMNVersion.DMN_14.getNamespace().equals(target.getNamespaceURI()) ||
                DMNVersion.DMN_14.getPrefixToNamespaceMap().get("dmndi").equals(target.getNamespaceURI())) {
