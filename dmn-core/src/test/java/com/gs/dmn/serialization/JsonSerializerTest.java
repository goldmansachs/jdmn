...
public class JsonSerializerTest {
    ...
    public void testTime() throws Exception {
        List<String[]> tuples = Arrays.asList(
                ...
                new String[] {"04:20:20.004@UTC", "04:20:20.004"},
                new String[] {"04:20:20.00421@UTC", "04:20:20.00421"}
        );
    ...
    public void testDateAndTime() throws Exception {
        List<String[]> tuples = Arrays.asList(
                ...
                new String[] {"2019-03-11T04:20:20.004@UTC", "2019-03-11T04:20:20.004"},
                new String[] {"2019-03-11T04:20:20.00421@UTC", "2019-03-11T04:20:20.00421"}
        );
        for (String[] pair : tuples) {
            // Serialization
            String literal = pair[0];
