...
public class TestNestedInputDataImports extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public void testCase001() {
        ...
        checkValues("B: Evaluating Say Hello to: Hello, B.A.John; B2: Evaluating Say Hello to: Hello, B2.A.John2", new nested_input_data_imports.ModelCDecisionBasedOnBs().apply(modelb2_modela_personName, modelb_modela_personName, annotationSet_, eventListener_, externalExecutor_));
    }
