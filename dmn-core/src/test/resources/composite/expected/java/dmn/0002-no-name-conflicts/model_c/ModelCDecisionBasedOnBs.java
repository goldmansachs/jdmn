...
public class ModelCDecisionBasedOnBs extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public Object apply(String model_a_personName, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            modelCDecisionBasedOnBsArguments_.put("personName", model_a_personName);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, modelCDecisionBasedOnBsArguments_);

            // Apply child decisions
            String model_b1_evaluatingB1SayHello = this.model_b1_evaluatingB1SayHello.apply(model_a_personName, annotationSet_, eventListener_, externalExecutor_);
            ...
            Object output_ = evaluate(model_b1_evaluatingB1SayHello, model_b2_evaluatingB2SayHello, annotationSet_, eventListener_, externalExecutor_);
    ...
    protected Object evaluate(String model_b1_evaluatingB1SayHello, String model_b2_evaluatingB2SayHello, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
