...
@javax.annotation.Generated(value = {"decision.ftl", "feelReplaceFunction_010_cd4e7a6d9f"})
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "",
    name = "feelReplaceFunction_010_cd4e7a6d9f",
    label = "",
...
public class FeelReplaceFunction_010_cd4e7a6d9f extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "",
        "feelReplaceFunction_010_cd4e7a6d9f",
        "",
    ...
    public FeelReplaceFunction_010_cd4e7a6d9f() {
    }
    ...
    public String apply(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            logError("Exception caught in 'feelReplaceFunction_010_cd4e7a6d9f' evaluation", e);
            return null;
        }
    }
