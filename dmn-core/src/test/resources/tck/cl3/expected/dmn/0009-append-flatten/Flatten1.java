...
public class Flatten1 extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    private final Append1 append1;

    public Flatten1() {
        this(new Append1());
    }

    public Flatten1(Append1 append1) {
    ...
    public List<String> apply(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            List<List<String>> append1Output = append1.apply(annotationSet_, eventListener_, externalExecutor_);

            // Evaluate expression
            List<String> output_ = evaluate(append1Output, annotationSet_, eventListener_, externalExecutor_);
    ...
    private List<String> evaluate(List<List<String>> append1, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        return flatten(append1);
    }
}
