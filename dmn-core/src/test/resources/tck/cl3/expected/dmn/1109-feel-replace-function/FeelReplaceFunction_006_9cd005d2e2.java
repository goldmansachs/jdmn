...
@javax.annotation.Generated(value = {"decision.ftl", "feelReplaceFunction_006_9cd005d2e2"})
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "",
    name = "feelReplaceFunction_006_9cd005d2e2",
    label = "",
...
public class FeelReplaceFunction_006_9cd005d2e2 extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "",
        "feelReplaceFunction_006_9cd005d2e2",
        "",
    ...
    public FeelReplaceFunction_006_9cd005d2e2() {
    }
    ...
    public String apply(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            logError("Exception caught in 'feelReplaceFunction_006_9cd005d2e2' evaluation", e);
            return null;
        }
    }
