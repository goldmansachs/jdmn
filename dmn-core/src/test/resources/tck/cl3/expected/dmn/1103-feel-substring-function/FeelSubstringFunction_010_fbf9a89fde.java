...
@javax.annotation.Generated(value = {"decision.ftl", "feelSubstringFunction_010_fbf9a89fde"})
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "",
    name = "feelSubstringFunction_010_fbf9a89fde",
    label = "",
...
public class FeelSubstringFunction_010_fbf9a89fde extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "",
        "feelSubstringFunction_010_fbf9a89fde",
        "",
    ...
    public FeelSubstringFunction_010_fbf9a89fde() {
    }
    ...
    public String apply(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            logError("Exception caught in 'feelSubstringFunction_010_fbf9a89fde' evaluation", e);
            return null;
        }
    }
    ...
    private String evaluate(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        return substring("foobar", number("3"), number("3.8"));
    }
}
