...
@javax.annotation.Generated(value = {"decision.ftl", "listGen5"})
...
public class ListGen5 extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public com.gs.dmn.runtime.RuleOutput rule0(String a, String b, String c, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        // Rule metadata
        ...
        // Apply rule
        ListGen5RuleOutput output_ = new ListGen5RuleOutput(false);
        if (Boolean.TRUE == booleanAnd(
            ...
            output_.setListGen5(a);

            // Add annotation
            annotationSet_.addAnnotation("listGen5", 0, "");
        }
    ...
    public com.gs.dmn.runtime.RuleOutput rule1(String a, String b, String c, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        // Rule metadata
        ...
        if (Boolean.TRUE == booleanAnd(
            ...
            // Compute output
            output_.setMatched(true);
            output_.setListGen5(b);

            // Add annotation
            annotationSet_.addAnnotation("listGen5", 1, "");
        }
    ...
    public com.gs.dmn.runtime.RuleOutput rule2(String a, String b, String c, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        // Rule metadata
        ...
        if (Boolean.TRUE == booleanAnd(
            ...
            // Compute output
            output_.setMatched(true);
            output_.setListGen5(c);

            // Add annotation
            annotationSet_.addAnnotation("listGen5", 2, "");
        }
