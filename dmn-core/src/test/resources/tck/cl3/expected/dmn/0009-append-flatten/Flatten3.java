...
@javax.annotation.Generated(value = {"decision.ftl", "flatten3"})
...
public class Flatten3 extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    private final Append3 append3;

    public Flatten3() {
        this(new Append3());
    }

    public Flatten3(Append3 append3) {
    ...
    public List<String> apply(String nestedList, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        try {
            ...
            logError("Cannot apply decision 'Flatten3'", e);
            return null;
        }
    }
    ...
    public List<String> apply(List<List<String>> nestedList, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            List<List<String>> append3Output = append3.apply(nestedList, annotationSet_, eventListener_, externalExecutor_);

            // Evaluate expression
            List<String> output_ = evaluate(append3Output, annotationSet_, eventListener_, externalExecutor_);
            ...
            logError("Exception caught in 'flatten3' evaluation", e);
            return null;
        }
    }

    private List<String> evaluate(List<List<String>> append3, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        return flatten(append3);
    }
}
