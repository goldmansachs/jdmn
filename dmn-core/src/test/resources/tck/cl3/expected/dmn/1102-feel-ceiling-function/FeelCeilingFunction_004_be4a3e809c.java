...
@javax.annotation.Generated(value = {"decision.ftl", "feelCeilingFunction_004_be4a3e809c"})
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "",
    name = "feelCeilingFunction_004_be4a3e809c",
    label = "",
...
public class FeelCeilingFunction_004_be4a3e809c extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "",
        "feelCeilingFunction_004_be4a3e809c",
        "",
    ...
    public FeelCeilingFunction_004_be4a3e809c() {
    }
    ...
    public java.math.BigDecimal apply(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            logError("Exception caught in 'feelCeilingFunction_004_be4a3e809c' evaluation", e);
            return null;
        }
    }
    ...
    private java.math.BigDecimal evaluate(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        return ceiling(numericMultiply(numericDivide(numericUnaryMinus(number("5")), number("2.3")), number("5")));
    }
}
