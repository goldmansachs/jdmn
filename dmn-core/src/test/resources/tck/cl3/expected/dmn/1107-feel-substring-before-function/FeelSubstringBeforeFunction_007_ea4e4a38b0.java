...
@javax.annotation.Generated(value = {"decision.ftl", "feelSubstringBeforeFunction_007_ea4e4a38b0"})
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "",
    name = "feelSubstringBeforeFunction_007_ea4e4a38b0",
    label = "",
...
public class FeelSubstringBeforeFunction_007_ea4e4a38b0 extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "",
        "feelSubstringBeforeFunction_007_ea4e4a38b0",
        "",
    ...
    public FeelSubstringBeforeFunction_007_ea4e4a38b0() {
    }
    ...
    public String apply(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            logError("Exception caught in 'feelSubstringBeforeFunction_007_ea4e4a38b0' evaluation", e);
            return null;
        }
    }
