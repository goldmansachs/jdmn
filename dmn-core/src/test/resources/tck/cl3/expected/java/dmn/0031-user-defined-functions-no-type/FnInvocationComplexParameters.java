...
public class FnInvocationComplexParameters extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    protected type.TFnInvocationComplexParamsResult evaluate(com.gs.dmn.runtime.Context fnLibrary, java.math.BigDecimal inputA, java.math.BigDecimal inputB, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_, com.gs.dmn.runtime.cache.Cache cache_) {
        java.math.BigDecimal functionInvocationInParameter = ((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("multiplyFn")).apply(((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("sumFn")).apply(inputA, inputA), ((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("sumFn")).apply(inputB, inputB));
        java.math.BigDecimal functionInvocationLiteralExpressionInParameter = ((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("multiplyFn")).apply(numericMultiply(inputA, inputA), (booleanEqual((booleanAnd(numericGreaterEqualThan(((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("subFn")).apply(inputA, inputB), number("0")), numericLessEqualThan(((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("subFn")).apply(inputA, inputB), number("10")))), Boolean.TRUE)) ? number("5") : number("10"));
