...
public class Applicant_repository extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public type.Applicant apply(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
        try {
            ...
            type.Applicant output_ = evaluate(annotationSet_, eventListener_, externalExecutor_);
    ...
    protected type.Applicant evaluate(com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_) {
