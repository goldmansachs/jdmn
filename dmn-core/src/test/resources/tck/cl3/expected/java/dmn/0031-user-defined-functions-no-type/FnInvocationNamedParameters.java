...
public class FnInvocationNamedParameters extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public type.TFnInvocationNamedResult apply(java.math.BigDecimal inputA, java.math.BigDecimal inputB, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_, com.gs.dmn.runtime.cache.Cache cache_) {
        try {
            ...
            com.gs.dmn.runtime.Context fnLibrary = this.fnLibrary.apply(annotationSet_, eventListener_, externalExecutor_, cache_);
    ...
    protected type.TFnInvocationNamedResult evaluate(com.gs.dmn.runtime.Context fnLibrary, java.math.BigDecimal inputA, java.math.BigDecimal inputB, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_, com.gs.dmn.runtime.cache.Cache cache_) {
        java.math.BigDecimal subResult = ((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("subFn")).apply(inputA, inputB);
        java.math.BigDecimal multiplicationResultNamed = ((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("multiplyFn")).apply(inputA, inputB);
        java.math.BigDecimal subResultMixed = ((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("subFn")).apply(inputB, inputA);
        java.math.BigDecimal divisionResultNamed = ((com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>)((com.gs.dmn.runtime.Context)fnLibrary).get("divideFn")).apply(inputA, inputB);
