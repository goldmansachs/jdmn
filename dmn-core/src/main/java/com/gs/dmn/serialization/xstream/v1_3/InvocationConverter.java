...
public class InvocationConverter extends ExpressionConverter {
    ...
    public InvocationConverter(XStream xstream, DMNVersion version) {
    ...
    protected void writeChildren(HierarchicalStreamWriter writer, MarshallingContext context, Object parent) {
        ...
        if (i.getExpression() != null)
            writeChildrenNode(writer, context, i.getExpression(), DMNBaseConverter.defineExpressionNodeName(xstream, i.getExpression()));
