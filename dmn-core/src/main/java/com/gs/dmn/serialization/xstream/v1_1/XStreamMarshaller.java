...
public class XStreamMarshaller implements SimpleDMNMarshaller {
    ...
    public Object unmarshal(URL input) {
        try {
            ...
            LOGGER.error("Error unmarshalling DMN model from url '%s'.".formatted(input), e);
        }
        return null;
    }
    ...
    private XStream newXStream() {
        ...
        xStream.registerConverter(new AssociationConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new AuthorityRequirementConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new BindingConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new BusinessKnowledgeModelConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new ContextConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new ContextEntryConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new DecisionConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new DecisionRuleConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new DecisionServiceConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new DecisionTableConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new DefinitionsConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new DMNElementReferenceConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new FunctionDefinitionConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new ImportConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new ImportedValuesConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new InformationItemConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new InformationRequirementConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new InputClauseConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new InputDataConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new InvocationConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new ItemDefinitionConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new KnowledgeRequirementConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new KnowledgeSourceConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new LiteralExpressionConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new OrganizationUnitConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new OutputClauseConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new PerformanceIndicatorConverter(xStream, DMNVersion.DMN_11));
        xStream.registerConverter(new RelationConverter(xStream, DMNVersion.DMN_11));
