...
public class XStreamMarshaller implements SimpleDMNMarshaller {
    ...
    private static void configureQNameMap(QNameMap nameMap) {
        nameMap.setDefaultNamespace(DMNVersion.DMN_12.getNamespace());
    }
    ...
    public String marshal(Object o) {
        try (
            ...
            if (o instanceof DMNBaseElement) {
                ...
                String dmnPrefix = base.getElementInfo().getNsContext().entrySet().stream().filter(kv -> DMNVersion.DMN_12.getNamespace().equals(kv.getValue())).findFirst().map(Map.Entry::getKey).orElse("");
    ...
    private XStream newXStream() {
        ...
        xStream.registerConverter(new RuleAnnotationClauseConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new RuleAnnotationConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("DMNDI", DMNDI.class);
        xStream.registerConverter(new DMNDIConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("DMNDiagram", DMNDiagram.class);
        xStream.registerConverter(new DMNDiagramConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("DMNStyle", DMNStyle.class);
        xStream.registerConverter(new DMNStyleConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("Size", Dimension.class);
        xStream.registerConverter(new DimensionConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("DMNShape", DMNShape.class);
        xStream.registerConverter(new DMNShapeConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("FillColor", Color.class);
        xStream.alias("StrokeColor", Color.class);
        xStream.alias("FontColor", Color.class);
        xStream.registerConverter(new ColorConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("Bounds", Bounds.class);
        xStream.registerConverter(new BoundsConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("DMNLabel", DMNLabel.class);
        xStream.registerConverter(new DMNLabelConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("DMNEdge", DMNEdge.class);
        xStream.registerConverter(new DMNEdgeConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("DMNDecisionServiceDividerLine", DMNDecisionServiceDividerLine.class);
        xStream.registerConverter(new DMNDecisionServiceDividerLineConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("waypoint", Point.class);
        xStream.registerConverter(new PointConverter(xStream, DMNVersion.DMN_12));
        xStream.alias("extension", DiagramElement.Extension.class);
        xStream.alias(DMNLabelConverter.TEXT, String.class);

        xStream.registerConverter(new AssociationConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new AuthorityRequirementConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new BindingConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new BusinessKnowledgeModelConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new ContextConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new ContextEntryConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new DecisionConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new DecisionRuleConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new DecisionServiceConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new DecisionTableConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new DefinitionsConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new DMNElementReferenceConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new FunctionDefinitionConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new ImportConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new ImportedValuesConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new InformationItemConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new InformationRequirementConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new InputClauseConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new InputDataConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new InvocationConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new ItemDefinitionConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new KnowledgeRequirementConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new KnowledgeSourceConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new LiteralExpressionConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new OrganizationUnitConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new OutputClauseConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new PerformanceIndicatorConverter(xStream, DMNVersion.DMN_12));
        xStream.registerConverter(new RelationConverter(xStream, DMNVersion.DMN_12));
        ...
        xStream.registerConverter(new DiagramElementExtensionConverter(xStream, DMNVersion.DMN_12, extensionRegisters));
