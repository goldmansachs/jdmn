...
public abstract class DMNBaseElementConverter extends DMNBaseConverter {
    ...
    protected void writeAttributes(HierarchicalStreamWriter writer, Object parent) {
        ...
        if (parent instanceof TDefinitions) {
            ...
            String dmndiURI = DMNVersion.DMN_13.getPrefixToNamespaceMap().get("dmndi");
            String diURI = DMNVersion.DMN_13.getPrefixToNamespaceMap().get("di");
            String dcURI = DMNVersion.DMN_13.getPrefixToNamespaceMap().get("dc");
