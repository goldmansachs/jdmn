...
public class XStreamMarshaller implements SimpleDMNMarshaller {
    ...
    public static void configureQNameMap(QNameMap nameMap) {
        nameMap.setDefaultNamespace(DMNVersion.DMN_15.getNamespace());
    }
    ...
    public String marshal(Object o) {
        try (
            ...
            if (o instanceof DMNBaseElement) {
                ...
                String dmnPrefix = base.getElementInfo().getNsContext().entrySet().stream().filter(kv -> DMNVersion.DMN_15.getNamespace().equals(kv.getValue())).findFirst().map(Map.Entry::getKey).orElse("");
    ...
    private XStream newXStream() {
        ...
        xStream.registerConverter(new RuleAnnotationClauseConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new RuleAnnotationConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("DMNDI", DMNDI.class);
        xStream.registerConverter(new DMNDIConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("DMNDiagram", DMNDiagram.class);
        xStream.registerConverter(new DMNDiagramConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("DMNStyle", DMNStyle.class);
        xStream.registerConverter(new DMNStyleConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("Size", Dimension.class);
        xStream.registerConverter(new DimensionConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("DMNShape", DMNShape.class);
        xStream.registerConverter(new DMNShapeConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("FillColor", Color.class);
        xStream.alias("StrokeColor", Color.class);
        xStream.alias("FontColor", Color.class);
        xStream.registerConverter(new ColorConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("Bounds", Bounds.class);
        xStream.registerConverter(new BoundsConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("DMNLabel", DMNLabel.class);
        xStream.registerConverter(new DMNLabelConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("DMNEdge", DMNEdge.class);
        xStream.registerConverter(new com.gs.dmn.serialization.xstream.v1_3.DMNEdgeConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("DMNDecisionServiceDividerLine", DMNDecisionServiceDividerLine.class);
        xStream.registerConverter(new DMNDecisionServiceDividerLineConverter(xStream, DMNVersion.DMN_15));
        xStream.alias("waypoint", Point.class);
        xStream.registerConverter(new PointConverter(xStream, DMNVersion.DMN_15));
        ...
        xStream.registerConverter(new AssociationConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new AuthorityRequirementConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new BindingConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new BusinessKnowledgeModelConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ContextConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ContextEntryConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new DecisionConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new DecisionRuleConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new DecisionServiceConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new DecisionTableConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new DefinitionsConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new DMNElementReferenceConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new GroupConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new FunctionDefinitionConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ImportConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ImportedValuesConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new InformationItemConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new InformationRequirementConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new InputClauseConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new InputDataConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new InvocationConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ItemDefinitionConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new KnowledgeRequirementConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new KnowledgeSourceConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new LiteralExpressionConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new OrganizationUnitConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new OutputClauseConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new PerformanceIndicatorConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new RelationConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new TextAnnotationConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new UnaryTestsConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new FunctionItemConverter(xStream, DMNVersion.DMN_15));

        xStream.registerConverter(new ChildExpressionConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new TypedChildExpressionConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ForConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new EveryConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new SomeConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ConditionalConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new FilterConverter(xStream, DMNVersion.DMN_15));

        xStream.registerConverter(new QNameConverter(DMNVersion.DMN_15));
        xStream.registerConverter(new DMNListConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ElementCollectionConverter(xStream, DMNVersion.DMN_15));
        xStream.registerConverter(new ExtensionElementsConverter(xStream, DMNVersion.DMN_15, extensionRegisters));
        xStream.registerConverter(new DiagramElementExtensionConverter(xStream, DMNVersion.DMN_15, extensionRegisters));
