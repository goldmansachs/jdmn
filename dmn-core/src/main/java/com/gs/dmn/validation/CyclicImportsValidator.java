...
public class CyclicImportsValidator extends SimpleDMNValidator {
    public CyclicImportsValidator() {
        this(new Slf4jBuildLogger(LOGGER));
    }

    public CyclicImportsValidator(BuildLogger logger) {
        super(logger);
    }
    ...
    public List<String> validate(DMNModelRepository repository) {
        ...
        Graph<TDefinitions> importGraph = repository.createImportGraph();
