    ...
    Statement contextExpressionToJava(TDRGElement element, TContext context, Environment elementEnvironment) {
     ...
     private Statement contextExpressionToJava(TDRGElement element, TContext context, Environment contextEnvironment, Map<TContextEntry, Expression> literalExpressionMap) {
        ...
        if (returnValue != null) {
            ...
            String expressionText = this.expressionFactory.makeVariableAssignment(this.dmnTransformer.itemDefinitionJavaSimpleClassName(complexJavaType), complexTypeVariable, this.dmnTransformer.defaultConstructor(this.dmnTransformer.itemDefinitionJavaSimpleClassName(complexJavaType)));
