...
public class ProtoBufferJavaFactory extends ProtoBufferFactory {
    protected static final Map<String, String> FEEL_TYPE_TO_NATIVE_PROTO_TYPE = new LinkedHashMap<>();
    ...
    static {
        ...
        FEEL_TYPE_TO_NATIVE_PROTO_TYPE.put(NULL.getName(), "Object");
        ...
        FEEL_TYPE_TO_NATIVE_PROTO_TYPE.put(ComparableDataType.COMPARABLE.getName(), "Object");
        FEEL_TYPE_TO_NATIVE_PROTO_TYPE.put(FEELType.typeName(ContextType.CONTEXT), "Object");
    }
