...
public class DRGElement {
    ...
    public DRGElement(String namespace, String name, String label, DRGElementKind elementKind, ExpressionKind expressionKind, HitPolicy hitPolicy, int rulesCount) {
