...
public class RuntimeEnvironmentFactory {
    ...
    public static RuntimeEnvironmentFactory instance() {
        return INSTANCE;
    }
    ...
    public RuntimeEnvironment makeEnvironment() {
        return makeEnvironment(null);
    }

    public RuntimeEnvironment makeEnvironment(RuntimeEnvironment parent) {
