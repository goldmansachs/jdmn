...
public class DMNToJavaTranslatorBuilder {
    ...
    private BuildLogger buildLogger = new Slf4jBuildLogger(LoggerFactory.getLogger(DMNToJavaTranslator.class));
    private DMNValidator dmnValidator = new NopDMNValidator();
    private TestValidator<TestCases> testCasesValidator = new NopTCKValidator();
    ...
    public DMNToJavaTranslatorBuilder withTestValidator(TestValidator<TestCases> testCasesValidator) {
