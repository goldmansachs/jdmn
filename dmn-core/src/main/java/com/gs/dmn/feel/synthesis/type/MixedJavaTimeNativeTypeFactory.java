...
public class MixedJavaTimeNativeTypeFactory extends JavaTypeFactory {
    ...
    static {
        ...
        FEEL_TYPE_TO_JAVA_TYPE.put(DATE_TIME_CAMEL.getName(), java.time.ZonedDateTime.class.getName());
        FEEL_TYPE_TO_JAVA_TYPE.put(DATE_TIME.getName(), java.time.ZonedDateTime.class.getName());
        FEEL_TYPE_TO_JAVA_TYPE.put(YEARS_AND_MONTHS_DURATION.getName(), javax.xml.datatype.Duration.class.getName());
        FEEL_TYPE_TO_JAVA_TYPE.put(YEAR_MONTH_DURATION.getName(), javax.xml.datatype.Duration.class.getName());
        FEEL_TYPE_TO_JAVA_TYPE.put(DAYS_AND_TIME_DURATION.getName(), javax.xml.datatype.Duration.class.getName());
        FEEL_TYPE_TO_JAVA_TYPE.put(DAY_TIME_DURATION.getName(), javax.xml.datatype.Duration.class.getName());
        ...
        FEEL_TYPE_TO_JAVA_TYPE.put(DurationType.DURATION.getName(), javax.xml.datatype.Duration.class.getName());
        FEEL_TYPE_TO_JAVA_TYPE.put(ComparableDataType.COMPARABLE.getName(), Object.class.getSimpleName());
    ...
    static {
        ...
        FEEL_TYPE_TO_QUALIFIED_JAVA_TYPE.put(DATE_TIME_CAMEL.getName(), java.time.ZonedDateTime.class.getName());
        FEEL_TYPE_TO_QUALIFIED_JAVA_TYPE.put(DATE_TIME.getName(), java.time.ZonedDateTime.class.getName());
        FEEL_TYPE_TO_QUALIFIED_JAVA_TYPE.put(YEARS_AND_MONTHS_DURATION.getName(), javax.xml.datatype.Duration.class.getName());
        FEEL_TYPE_TO_QUALIFIED_JAVA_TYPE.put(YEAR_MONTH_DURATION.getName(), javax.xml.datatype.Duration.class.getName());
        FEEL_TYPE_TO_QUALIFIED_JAVA_TYPE.put(DAYS_AND_TIME_DURATION.getName(), javax.xml.datatype.Duration.class.getName());
        FEEL_TYPE_TO_QUALIFIED_JAVA_TYPE.put(DAY_TIME_DURATION.getName(), javax.xml.datatype.Duration.class.getName());
