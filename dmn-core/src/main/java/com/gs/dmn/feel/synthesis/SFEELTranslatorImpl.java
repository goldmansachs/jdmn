...
public class SFEELTranslatorImpl extends AbstractFEELTranslator {
    ...
    public SFEELTranslatorImpl(BasicDMN2JavaTransformer dmnTransformer) {
        this(new SFEELAnalyzerImpl(dmnTransformer), new FEELToJavaVisitor(dmnTransformer), new SimpleExpressionsToJavaVisitor(dmnTransformer));
    }
}
