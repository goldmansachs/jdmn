...
public class UniformJavaTimeFEELTypeTranslator implements FEELTypeTranslator {
    ...
    static {
        ...
        TIME_FEEL_TO_JAVA_TYPE.put(TIME.getName(), java.time.ZonedDateTime.class.getName());
        TIME_FEEL_TO_JAVA_TYPE.put(DATE.getName(), java.time.ZonedDateTime.class.getName());
    ...
    static {
        ...
        TIME_FEEL_TO_QUALIFIED_JAVA_TYPE.put(TIME.getName(), java.time.ZonedDateTime.class.getName());
