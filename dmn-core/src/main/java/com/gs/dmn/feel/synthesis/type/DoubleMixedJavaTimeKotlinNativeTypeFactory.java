...
public class DoubleMixedJavaTimeKotlinNativeTypeFactory extends KotlinTypeFactory {
    private static final Map<String, String> TIME_FEEL_TO_JAVA_TYPE = new LinkedHashMap<>();
    static {
        TIME_FEEL_TO_JAVA_TYPE.put(ENUMERATION.getName(), String.class.getName());
        ...
        TIME_FEEL_TO_JAVA_TYPE.put(ANY.getName(), "kotlin.Any");
    }

    private static final Map<String, String> TIME_FEEL_TO_QUALIFIED_JAVA_TYPE = new LinkedHashMap<>();
    static {
        TIME_FEEL_TO_QUALIFIED_JAVA_TYPE.put(ENUMERATION.getName(), "kotlin.String");
        ...
        TIME_FEEL_TO_QUALIFIED_JAVA_TYPE.put(STRING.getName(), "kotlin.String");
        TIME_FEEL_TO_QUALIFIED_JAVA_TYPE.put(BOOLEAN.getName(), "kotlin.Boolean");
        TIME_FEEL_TO_QUALIFIED_JAVA_TYPE.put(NUMBER.getName(), Double.class.getName());
        TIME_FEEL_TO_QUALIFIED_JAVA_TYPE.put(ANY.getName(), "kotlin.Any");
    }
