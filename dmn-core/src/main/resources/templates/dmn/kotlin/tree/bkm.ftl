...
class ${javaClassName} : ${decisionBaseClass} {
    ...
    private fun apply(${transformer.drgElementSignatureExtra(transformer.drgElementSignature(drgElement))}): ${transformer.drgElementOutputType(drgElement)} {
    ...
    companion object {
        ...
        fun ${transformer.bkmFunctionName(drgElement)}(${transformer.drgElementSignatureExtra(transformer.drgElementSignature(drgElement))}): ${transformer.drgElementOutputType(drgElement)} {
