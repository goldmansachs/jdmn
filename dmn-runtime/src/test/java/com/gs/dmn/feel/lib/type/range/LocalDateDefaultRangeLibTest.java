...
public class LocalDateDefaultRangeLibTest extends AbstractDefaultRangeLibTest<BigDecimal, LocalDate, OffsetTime, ZonedDateTime, Duration> {
    @Override
    ...
    @Override
    protected LocalDate makePoint(int number) {
