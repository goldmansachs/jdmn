...
public class DefaultRangeLibTest {
    ...
    private BigDecimal makePoint(String number) {
        return feelLib.number(number);
    }

    private Range makeRange(String startIncluded, String start, String end, String endIncluded) {
