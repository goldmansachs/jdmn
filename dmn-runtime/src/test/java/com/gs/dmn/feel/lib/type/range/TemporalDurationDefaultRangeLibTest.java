...
public class TemporalDurationDefaultRangeLibTest extends AbstractDefaultRangeLibTest<Number, LocalDate, TemporalAccessor, TemporalAccessor, TemporalAmount> {
    @Override
