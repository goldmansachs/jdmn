...
public class DecimalNumericType extends BaseNumericType implements NumericType<BigDecimal> {
    ...
    public DecimalNumericType() {
        this(new ComparableComparator<>());
    }

    public DecimalNumericType(ComparableComparator<BigDecimal> comparator) {
