...
public abstract class BaseFEELLib<NUMBER, DATE, TIME, DATE_TIME, DURATION> implements FEELLib<NUMBER, DATE, TIME, DATE_TIME, DURATION> {
    ...
    protected  <T> IterationDomain iterationDomain(boolean isOpenStart, T start, boolean isOpenEnd, T end) {
    ...
    protected <T> IterationDomain iterationDomain(T start, T end) {
        if (start == null || end == null) {
            return null;
        }
