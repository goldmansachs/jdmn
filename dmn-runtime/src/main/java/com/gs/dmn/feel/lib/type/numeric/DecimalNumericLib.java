...
import static com.gs.dmn.feel.lib.type.numeric.DecimalNumericType.MATH_CONTEXT;

public class DecimalNumericLib extends BaseNumericLib<BigDecimal> {
    @Override
    ...
    public BigDecimal modulo(BigDecimal dividend, BigDecimal divisor) {
        ...
        return dividend.subtract(divisor.multiply(floor(DecimalNumericType.decimalNumericDivide(dividend, divisor), BigDecimal.ZERO)));
    }
    ...
    public BigDecimal mean(List<?> list) {
        ...
        return DecimalNumericType.decimalNumericDivide(sum, BigDecimal.valueOf(list.size()));
    }
