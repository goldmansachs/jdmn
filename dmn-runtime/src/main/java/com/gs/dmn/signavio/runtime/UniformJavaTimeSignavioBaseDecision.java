...
public class UniformJavaTimeSignavioBaseDecision extends UniformJavaTimeSignavioLib
        ...
        AnnotationTarget
{
    ...
    public Rule getRuleAnnotation(int ruleIndex) {
        ...
        Class<? extends UniformJavaTimeSignavioBaseDecision> cls = this.getClass();
