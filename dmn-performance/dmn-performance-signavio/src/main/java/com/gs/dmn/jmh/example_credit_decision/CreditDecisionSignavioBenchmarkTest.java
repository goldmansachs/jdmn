...
public class CreditDecisionSignavioBenchmarkTest {
...
//        System.out.println(String.format("Compiled version took %s ms", endTime - startTime));
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(CreditDecisionSignavioBenchmarkTest.class.getSimpleName())
        ...
        PerformanceUtils.printReport(runResults, "signavio-benchmark.txt");
