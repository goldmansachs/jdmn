...
public class StringTestExecutionBenchmarkTest {
    private final TestCasesExecutor executor = new StringTestCasesExecutor();
...
//        System.out.println(String.format("Compiled version took %s ms", endTime - startTime));
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(StringTestExecutionBenchmarkTest.class.getSimpleName())
        ...
        PerformanceUtils.printReport(runResults, "standard-string-test-execution-benchmark.txt");
