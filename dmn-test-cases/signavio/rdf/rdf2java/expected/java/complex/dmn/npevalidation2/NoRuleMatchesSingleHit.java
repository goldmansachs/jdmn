...
public class NoRuleMatchesSingleHit extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<Boolean> {
    ...
    public Boolean apply(java.lang.Number second, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            noRuleMatchesSingleHitArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#second", second);
    ...
    protected Boolean evaluate(java.lang.Number second, com.gs.dmn.runtime.ExecutionContext context_) {
        com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_ = context_ != null ? context_.getAnnotations() : null;
        com.gs.dmn.runtime.listener.EventListener eventListener_ = context_ != null ? context_.getEventListener() : null;
        com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_ = context_ != null ? context_.getExternalFunctionExecutor() : null;
        com.gs.dmn.runtime.cache.Cache cache_ = context_ != null ? context_.getCache() : null;
        ...
        if (ruleOutputList_.noMatchedRules()) {
            ...
            output_ = ruleOutput_ == null ? null : ((NoRuleMatchesSingleHitRuleOutput)ruleOutput_).getNoRuleMatches();
        }
