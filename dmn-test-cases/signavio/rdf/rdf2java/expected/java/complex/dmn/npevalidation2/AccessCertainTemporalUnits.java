...
public class AccessCertainTemporalUnits extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<List<java.lang.Number>> {
    ...
    public List<java.lang.Number> apply(java.lang.Number day, java.lang.Number hour, java.lang.Number minute, java.lang.Number month, java.lang.Number second, java.lang.Number year, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            accessCertainTemporalUnitsArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#day", day);
            accessCertainTemporalUnitsArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#hour", hour);
            accessCertainTemporalUnitsArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#minute", minute);
            accessCertainTemporalUnitsArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#month", month);
            accessCertainTemporalUnitsArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#second", second);
            accessCertainTemporalUnitsArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#year", year);
    ...
    protected List<java.lang.Number> evaluate(java.lang.Number day, java.lang.Number hour, java.lang.Number minute, java.lang.Number month, java.lang.Number second, java.lang.Number year, com.gs.dmn.runtime.ExecutionContext context_) {
        ...
        if (ruleOutputList_.noMatchedRules()) {
            ...
            output_ = ruleOutputs_.stream().map(ro_ -> ((AccessCertainTemporalUnitsRuleOutput)ro_).getValue()).collect(Collectors.toList());
        }
