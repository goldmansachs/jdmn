...
public class DescribeAgesList extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<List<String>> {
    ...
    public List<String> apply(List<java.lang.Number> ages, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            describeAgesListArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#ages", ages);
    ...
    protected List<String> evaluate(List<java.lang.Number> ages, com.gs.dmn.runtime.ExecutionContext context_) {
        ...
        if (ruleOutputList_.noMatchedRules()) {
            ...
            output_ = ruleOutputs_.stream().map(ro_ -> ((DescribeAgesListRuleOutput)ro_).getListDescription()).collect(Collectors.toList());
        }
