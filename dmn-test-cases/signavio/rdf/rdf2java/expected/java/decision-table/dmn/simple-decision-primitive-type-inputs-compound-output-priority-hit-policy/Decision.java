...
public class Decision extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<type.Decision> {
    ...
    @java.lang.Override()
    public type.Decision applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
    ...
    public type.Decision apply(java.lang.Number numberInput, String textInput, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#numberInput", numberInput);
            decisionArguments_.put("http://www.omg.org/spec/DMN/20151101/dmn.xsd#textInput", textInput);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decisionArguments_);

            // Evaluate decision 'decision'
            type.Decision output_ = evaluate(numberInput, textInput, context_);
    ...
    protected type.Decision evaluate(java.lang.Number numberInput, String textInput, com.gs.dmn.runtime.ExecutionContext context_) {
        com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_ = context_ != null ? context_.getAnnotations() : null;
        com.gs.dmn.runtime.listener.EventListener eventListener_ = context_ != null ? context_.getEventListener() : null;
        com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_ = context_ != null ? context_.getExternalFunctionExecutor() : null;
        com.gs.dmn.runtime.cache.Cache cache_ = context_ != null ? context_.getCache() : null;
