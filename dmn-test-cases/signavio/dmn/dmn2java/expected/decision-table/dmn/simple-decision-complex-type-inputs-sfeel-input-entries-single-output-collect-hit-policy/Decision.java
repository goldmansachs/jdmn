...
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "http://www.provider.com/dmn/1.1/diagram/2798baf8f6de4bd3b984e599fa9ff016.xml",
    name = "decision",
    label = "Decision",
...
public class Decision extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<List<String>> {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "http://www.provider.com/dmn/1.1/diagram/2798baf8f6de4bd3b984e599fa9ff016.xml",
        "decision",
        "Decision",
    ...
    public List<String> apply(Boolean employed, type.Person person, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/2798baf8f6de4bd3b984e599fa9ff016.xml#employed", employed);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/2798baf8f6de4bd3b984e599fa9ff016.xml#person", person);
    ...
    public com.gs.dmn.runtime.RuleOutput rule0(Boolean employed, type.Person person, com.gs.dmn.runtime.ExecutionContext context_) {
        ...
        if (ruleMatches(eventListener_, drgRuleMetadata,
            ...
            timeEqual(((java.time.temporal.TemporalAccessor)(person != null ? person.getTimeOfBirth() : null)), time("01:00:00+0000")),
            dateTimeEqual(((java.time.temporal.TemporalAccessor)(person != null ? person.getDateTimeOfBirth() : null)), dateAndTime("2016-10-01T00:00:00+0000")),
