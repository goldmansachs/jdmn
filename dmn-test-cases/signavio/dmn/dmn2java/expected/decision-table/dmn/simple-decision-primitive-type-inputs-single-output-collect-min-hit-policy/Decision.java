...
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "http://www.provider.com/dmn/1.1/diagram/1dc1eafdffaa47f8a3f9814c50024726.xml",
    name = "decision",
    label = "Decision",
...
public class Decision extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<java.lang.Number> {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "http://www.provider.com/dmn/1.1/diagram/1dc1eafdffaa47f8a3f9814c50024726.xml",
        "decision",
        "Decision",
    ...
    public java.lang.Number apply(java.lang.Number numberInput, String textInput, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/1dc1eafdffaa47f8a3f9814c50024726.xml#numberInput", numberInput);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/1dc1eafdffaa47f8a3f9814c50024726.xml#textInput", textInput);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decisionArguments_);

            // Evaluate decision 'decision'
            java.lang.Number output_ = evaluate(numberInput, textInput, context_);
    ...
    protected java.lang.Number evaluate(java.lang.Number numberInput, String textInput, com.gs.dmn.runtime.ExecutionContext context_) {
        com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_ = context_ != null ? context_.getAnnotations() : null;
        com.gs.dmn.runtime.listener.EventListener eventListener_ = context_ != null ? context_.getEventListener() : null;
        com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_ = context_ != null ? context_.getExternalFunctionExecutor() : null;
        com.gs.dmn.runtime.cache.Cache cache_ = context_ != null ? context_.getCache() : null;
        ...
        if (ruleOutputList_.noMatchedRules()) {
            ...
            output_ = min(ruleOutputs_.stream().map(x_ -> ((DecisionRuleOutput)x_).getDecision()).collect(Collectors.toList()));
        }
