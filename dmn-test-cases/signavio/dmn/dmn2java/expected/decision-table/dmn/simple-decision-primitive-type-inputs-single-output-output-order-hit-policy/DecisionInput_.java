...
public class DecisionInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public DecisionInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
            Object numberInput = input_.get("http://www.provider.com/dmn/1.1/diagram/62c243d2fb104c65912386ec684b2ee1.xml#numberInput");
            setNumberInput((java.lang.Number)numberInput);
            Object textInput = input_.get("http://www.provider.com/dmn/1.1/diagram/62c243d2fb104c65912386ec684b2ee1.xml#textInput");
