...
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "http://www.provider.com/dmn/1.1/diagram/62c243d2fb104c65912386ec684b2ee1.xml",
    name = "decision",
    label = "Decision",
...
public class Decision extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<List<String>> {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "http://www.provider.com/dmn/1.1/diagram/62c243d2fb104c65912386ec684b2ee1.xml",
        "decision",
        "Decision",
    ...
    public List<String> apply(java.lang.Number numberInput, String textInput, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/62c243d2fb104c65912386ec684b2ee1.xml#numberInput", numberInput);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/62c243d2fb104c65912386ec684b2ee1.xml#textInput", textInput);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decisionArguments_);

            // Evaluate decision 'decision'
            List<String> output_ = evaluate(numberInput, textInput, context_);
    ...
    protected List<String> evaluate(java.lang.Number numberInput, String textInput, com.gs.dmn.runtime.ExecutionContext context_) {
        com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_ = context_ != null ? context_.getAnnotations() : null;
        com.gs.dmn.runtime.listener.EventListener eventListener_ = context_ != null ? context_.getEventListener() : null;
        com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_ = context_ != null ? context_.getExternalFunctionExecutor() : null;
        com.gs.dmn.runtime.cache.Cache cache_ = context_ != null ? context_.getCache() : null;
        ...
        if (ruleOutputList_.noMatchedRules()) {
            ...
            output_ = ruleOutputs_.stream().map(ro_ -> ((DecisionRuleOutput)ro_).getDecision()).collect(Collectors.toList());
        }
