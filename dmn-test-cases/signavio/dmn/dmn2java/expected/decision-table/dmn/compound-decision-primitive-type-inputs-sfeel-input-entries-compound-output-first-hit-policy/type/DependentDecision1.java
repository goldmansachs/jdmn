...
public interface DependentDecision1 extends com.gs.dmn.runtime.DMNType {
    static DependentDecision1 toDependentDecision1(Object other) {
        if (other == null) {
            ...
            Object dD1O1 = ((com.gs.dmn.runtime.Context)other).get("dD1O1", "DD1O1");
            result_.setDD1O1((String)dD1O1);
            Object dD1O2 = ((com.gs.dmn.runtime.Context)other).get("dD1O2", "DD1O2");
            result_.setDD1O2((String)dD1O2);
            return result_;
