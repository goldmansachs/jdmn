...
public interface DependentDecision2 extends com.gs.dmn.runtime.DMNType {
    static DependentDecision2 toDependentDecision2(Object other) {
        if (other == null) {
            ...
            Object dD2O1 = ((com.gs.dmn.runtime.Context)other).get("dD2O1", "DD2O1");
            result_.setDD2O1((String)dD2O1);
            Object dD2O2 = ((com.gs.dmn.runtime.Context)other).get("dD2O2", "DD2O2");
            result_.setDD2O2((String)dD2O2);
            return result_;
    ...
    default com.gs.dmn.runtime.Context toContext() {
        ...
        context.add("dD2O1", getDD2O1());
        context.add("dD2O2", getDD2O2());
        return context;
    }
