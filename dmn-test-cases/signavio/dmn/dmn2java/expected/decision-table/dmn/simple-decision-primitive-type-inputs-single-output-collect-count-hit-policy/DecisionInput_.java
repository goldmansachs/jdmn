...
public class DecisionInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public DecisionInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
            Object numberInput = input_.get("http://www.provider.com/dmn/1.1/diagram/720ce15dd8694bb3b91aa8d0a01351db.xml#numberInput");
            setNumberInput((java.lang.Number)numberInput);
            Object textInput = input_.get("http://www.provider.com/dmn/1.1/diagram/720ce15dd8694bb3b91aa8d0a01351db.xml#textInput");
