...
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "http://www.provider.com/dmn/1.1/diagram/69b8ec68a443433f993135b386b718df.xml",
    name = "decision",
    label = "Decision",
...
public class Decision extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<String> {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "http://www.provider.com/dmn/1.1/diagram/69b8ec68a443433f993135b386b718df.xml",
        "decision",
        "Decision",
    ...
    public String apply(java.lang.Number numberInput, String textInput, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/69b8ec68a443433f993135b386b718df.xml#numberInput", numberInput);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/69b8ec68a443433f993135b386b718df.xml#textInput", textInput);
