...
public class ChildObject extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<java.lang.Number> {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "http://www.provider.com/dmn/1.1/diagram/80afa9e878bb4885a8f5be36b6f16abc.xml",
        "childObject",
        "ChildObject",
    ...
    private final child.Abc child_abc;

    public ChildObject() {
        this(new child.Abc());
    }

    public ChildObject(child.Abc child_abc) {
        this.child_abc = child_abc;
    }
    ...
    public java.lang.Number apply(java.lang.Number num, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            childObjectArguments_.put("http://www.provider.com/dmn/1.1/diagram/c3d5f975281b4d2f829ee2c77b320f01.xml#num", num);
    ...
    protected java.lang.Number evaluate(java.lang.Number num, com.gs.dmn.runtime.ExecutionContext context_) {
        ...
        java.lang.Number child_abc = this.child_abc.apply(num, context_);
