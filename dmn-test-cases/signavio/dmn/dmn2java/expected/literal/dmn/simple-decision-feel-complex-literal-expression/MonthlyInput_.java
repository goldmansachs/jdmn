...
@javax.annotation.Generated(value = {"elementInput.ftl", "monthly"})
...
public class MonthlyInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public MonthlyInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
            Object loan = input_.get("http://www.provider.com/dmn/1.1/diagram/364e3a8fdb6f4466977ac99ee9564f12.xml#loan");
