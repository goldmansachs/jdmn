...
public class DecisionInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public DecisionInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
            Object booleanInput = input_.get("http://www.provider.com/dmn/1.1/diagram/d5db2eb40b954984a4b08fa9d680835e.xml#booleanInput");
            setBooleanInput((Boolean)booleanInput);
            Object dateInput = input_.get("http://www.provider.com/dmn/1.1/diagram/d5db2eb40b954984a4b08fa9d680835e.xml#dateInput");
            setDateInput((java.time.LocalDate)dateInput);
            Object enumerationInput = input_.get("http://www.provider.com/dmn/1.1/diagram/d5db2eb40b954984a4b08fa9d680835e.xml#enumerationInput");
            setEnumerationInput((String)enumerationInput);
            Object numberInput = input_.get("http://www.provider.com/dmn/1.1/diagram/d5db2eb40b954984a4b08fa9d680835e.xml#numberInput");
            setNumberInput((java.lang.Number)numberInput);
            Object stringInput = input_.get("http://www.provider.com/dmn/1.1/diagram/d5db2eb40b954984a4b08fa9d680835e.xml#stringInput");
