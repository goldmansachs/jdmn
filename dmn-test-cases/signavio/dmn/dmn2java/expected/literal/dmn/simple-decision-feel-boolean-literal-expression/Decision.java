...
public class Decision extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<Boolean> {
    ...
    public Boolean apply(Boolean booleanInput, java.time.LocalDate dateInput, String enumerationInput, java.lang.Number numberInput, String stringInput, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/d01479ef8b18467d9e4ce7eb7d03f7dc.xml#booleanInput", booleanInput);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/d01479ef8b18467d9e4ce7eb7d03f7dc.xml#dateInput", dateInput);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/d01479ef8b18467d9e4ce7eb7d03f7dc.xml#enumerationInput", enumerationInput);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/d01479ef8b18467d9e4ce7eb7d03f7dc.xml#numberInput", numberInput);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/d01479ef8b18467d9e4ce7eb7d03f7dc.xml#stringInput", stringInput);
