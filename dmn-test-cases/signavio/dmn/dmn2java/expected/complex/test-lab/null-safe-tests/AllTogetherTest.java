...
public class AllTogetherTest extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<Object> {
    ...
    public void testCase1() {
        ...
        List<java.lang.Number> numberList = asList(number("10"), number("20"), number("30"), number("40"));
        java.lang.Number numberA = number("12");
        java.time.temporal.TemporalAccessor time = time("13:00:00+00:00");
        List<String> stringList = asList("Foo", "Bar");
        java.time.LocalDate date = date("2015-01-01");
        String allTogether = this.allTogether.apply(booleanA, booleanB, booleanList, date, dateTime, numberA, numberB, numberList, string, stringList, time, context_);
    ...
    public void testCase2() {
        ...
        List<java.lang.Number> numberList = asList(null, null, null);
        java.lang.Number numberA = number("12");
        java.time.temporal.TemporalAccessor time = time("12:00:00+00:00");
        List<String> stringList = asList("Some", "Thing");
        java.time.LocalDate date = date("2016-11-16");
        String allTogether = this.allTogether.apply(booleanA, booleanB, booleanList, date, dateTime, numberA, numberB, numberList, string, stringList, time, context_);
    ...
    public void testCase3() {
        ...
        List<java.lang.Number> numberList = asList(number("1"), number("2"), number("1"));
        java.lang.Number numberA = number("23");
        java.time.temporal.TemporalAccessor time = time("11:11:11+00:00");
        List<String> stringList = asList("1", "2", "3");
        java.time.LocalDate date = date("2016-11-09");
        String allTogether = this.allTogether.apply(booleanA, booleanB, booleanList, date, dateTime, numberA, numberB, numberList, string, stringList, time, context_);
    ...
    public void testCase4() {
        ...
        List<java.lang.Number> numberList = asList(number("1"), number("2"), number("3"));
        java.lang.Number numberA = number("11");
        java.time.temporal.TemporalAccessor time = time("12:12:12+00:00");
        List<String> stringList = asList("a", "d", "s");
        java.time.LocalDate date = date("2016-11-01");
        String allTogether = this.allTogether.apply(booleanA, booleanB, booleanList, date, dateTime, numberA, numberB, numberList, string, stringList, time, context_);
    ...
    public void testCase5() {
        ...
        List<java.lang.Number> numberList = asList(number("9"), number("8"), number("7"));
        java.lang.Number numberA = number("90");
        java.time.temporal.TemporalAccessor time = time("12:12:12+00:00");
        List<String> stringList = asList("A", "B", "C");
        java.time.LocalDate date = date("2016-11-18");
        String allTogether = this.allTogether.apply(booleanA, booleanB, booleanList, date, dateTime, numberA, numberB, numberList, string, stringList, time, context_);
    ...
    public void testCase6() {
        ...
        List<java.lang.Number> numberList = asList(number("4"), number("24"), number("4"));
        java.lang.Number numberA = number("12");
        java.time.temporal.TemporalAccessor time = time("11:11:11+00:00");
        List<String> stringList = asList("123", "234", "345");
        java.time.LocalDate date = date("2016-11-03");
        String allTogether = this.allTogether.apply(booleanA, booleanB, booleanList, date, dateTime, numberA, numberB, numberList, string, stringList, time, context_);
