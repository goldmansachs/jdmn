...
@javax.annotation.Generated(value = {"inputElement.ftl", "accessCertainTemporalUnits"})
@com.fasterxml.jackson.annotation.JsonPropertyOrder(alphabetic = true)
public class AccessCertainTemporalUnitsInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public AccessCertainTemporalUnitsInput_() {
    }

    public AccessCertainTemporalUnitsInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
