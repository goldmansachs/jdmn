...
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "http://www.provider.com/dmn/1.1/diagram/7bf105649e8445b39cb4d936497fbc1c.xml",
    name = "zip",
    label = "zip",
...
public class Zip extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<List<type.Zip>> {
    ...
    public List<type.Zip> apply(List<String> inputA, List<java.lang.Number> inputB, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            zipArguments_.put("http://www.provider.com/dmn/1.1/diagram/7bf105649e8445b39cb4d936497fbc1c.xml#inputA", inputA);
            zipArguments_.put("http://www.provider.com/dmn/1.1/diagram/7bf105649e8445b39cb4d936497fbc1c.xml#inputB", inputB);
