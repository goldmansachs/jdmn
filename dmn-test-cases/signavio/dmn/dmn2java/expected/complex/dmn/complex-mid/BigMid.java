...
public class BigMid extends com.gs.dmn.signavio.runtime.DefaultSignavioBaseDecision {
    ...
    @java.lang.Override()
    public List<Boolean> apply(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("TestPeopleType"), context_.getAnnotations(), context_.getEventListener(), context_.getExternalFunctionExecutor(), context_.getCache());
        } catch (Exception e) {
