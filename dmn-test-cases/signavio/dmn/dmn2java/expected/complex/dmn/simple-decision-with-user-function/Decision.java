...
@com.gs.dmn.runtime.annotation.DRGElement(
    namespace = "http://www.provider.com/dmn/1.1/diagram/de7a0645edac43999154e9b141c9d66a.xml",
    name = "decision",
    label = "Decision",
...
public class Decision extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<Boolean> {
    ...
    public Boolean applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("Age") != null ? number(input_.get("Age")) : null), context_);
        } catch (Exception e) {
    ...
    public Boolean apply(java.lang.Number age, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/de7a0645edac43999154e9b141c9d66a.xml#age", age);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decisionArguments_);

            // Evaluate decision 'decision'
            Boolean output_ = evaluate(age, context_);
    ...
    protected Boolean evaluate(java.lang.Number age, com.gs.dmn.runtime.ExecutionContext context_) {
        com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_ = context_ != null ? context_.getAnnotations() : null;
        com.gs.dmn.runtime.listener.EventListener eventListener_ = context_ != null ? context_.getEventListener() : null;
        com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_ = context_ != null ? context_.getExternalFunctionExecutor() : null;
        com.gs.dmn.runtime.cache.Cache cache_ = context_ != null ? context_.getCache() : null;
