...
public class Decision extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<String> {
    ...
    public String applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("d") != null ? date(input_.get("d")) : null), (input_.get("t") != null ? time(input_.get("t")) : null), context_);
        } catch (Exception e) {
    ...
    public String apply(java.time.LocalDate d, java.time.temporal.TemporalAccessor t, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/af75837563be485d941eba0f9bf7a5f4.xml#d", d);
            decisionArguments_.put("http://www.provider.com/dmn/1.1/diagram/af75837563be485d941eba0f9bf7a5f4.xml#t", t);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decisionArguments_);

            // Evaluate decision 'decision'
            String output_ = evaluate(d, t, context_);
    ...
    protected String evaluate(java.time.LocalDate d, java.time.temporal.TemporalAccessor t, com.gs.dmn.runtime.ExecutionContext context_) {
        ...
        com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_ = context_ != null ? context_.getExternalFunctionExecutor() : null;
        com.gs.dmn.runtime.cache.Cache cache_ = context_ != null ? context_.getCache() : null;
        return Logic.instance().apply(d, t, context_);
    }
}
