...
public class TimeFormula extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<List<java.lang.Number>> {
    ...
    public List<java.lang.Number> apply(java.time.temporal.TemporalAccessor time, java.time.temporal.TemporalAccessor time2, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            timeFormulaArguments_.put("http://www.provider.com/dmn/1.1/diagram/af75837563be485d941eba0f9bf7a5f4.xml#time", time);
            timeFormulaArguments_.put("http://www.provider.com/dmn/1.1/diagram/af75837563be485d941eba0f9bf7a5f4.xml#time2", time2);
    ...
    protected List<java.lang.Number> evaluate(java.time.temporal.TemporalAccessor time, java.time.temporal.TemporalAccessor time2, com.gs.dmn.runtime.ExecutionContext context_) {
        ...
        if (ruleOutputList_.noMatchedRules()) {
            ...
            output_ = ruleOutputs_.stream().map(ro_ -> ((TimeFormulaRuleOutput)ro_).getTimeFormula()).collect(Collectors.toList());
        }
