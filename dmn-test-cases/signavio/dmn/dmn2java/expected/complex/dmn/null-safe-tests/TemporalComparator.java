...
public class TemporalComparator extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<List<String>> {
    ...
    protected List<String> evaluate(java.time.temporal.TemporalAccessor dateTime, com.gs.dmn.runtime.ExecutionContext context_) {
        ...
        if (ruleOutputList_.noMatchedRules()) {
            ...
            output_ = ruleOutputs_.stream().map(ro_ -> ((TemporalComparatorRuleOutput)ro_).getTemporalComparator()).collect(Collectors.toList());
        }
