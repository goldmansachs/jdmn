...
@javax.annotation.Generated(value = {"elementInput.ftl", "stringHandling"})
...
public class StringHandlingInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public StringHandlingInput_() {
    }

    public StringHandlingInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
