...
public class Comparator extends com.gs.dmn.signavio.runtime.JavaTimeSignavioBaseDecision<List<String>> {
    ...
    public List<String> applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("numberA") != null ? number(input_.get("numberA")) : null), context_);
        } catch (Exception e) {
    ...
    public List<String> apply(java.lang.Number numberA, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            List<String> output_ = evaluate(numberA, context_);
    ...
    protected List<String> evaluate(java.lang.Number numberA, com.gs.dmn.runtime.ExecutionContext context_) {
        com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_ = context_ != null ? context_.getAnnotations() : null;
        com.gs.dmn.runtime.listener.EventListener eventListener_ = context_ != null ? context_.getEventListener() : null;
        com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_ = context_ != null ? context_.getExternalFunctionExecutor() : null;
        com.gs.dmn.runtime.cache.Cache cache_ = context_ != null ? context_.getCache() : null;
        ...
        ruleOutputList_.add(rule0(numberA, context_));
        ruleOutputList_.add(rule1(numberA, context_));
        ruleOutputList_.add(rule2(numberA, context_));
        ruleOutputList_.add(rule3(numberA, context_));
        ruleOutputList_.add(rule4(numberA, context_));
        ruleOutputList_.add(rule5(numberA, context_));
    ...
    public com.gs.dmn.runtime.RuleOutput rule0(java.lang.Number numberA, com.gs.dmn.runtime.ExecutionContext context_) {
        // Rule metadata
    ...
    public com.gs.dmn.runtime.RuleOutput rule1(java.lang.Number numberA, com.gs.dmn.runtime.ExecutionContext context_) {
        // Rule metadata
    ...
    public com.gs.dmn.runtime.RuleOutput rule2(java.lang.Number numberA, com.gs.dmn.runtime.ExecutionContext context_) {
        // Rule metadata
    ...
    public com.gs.dmn.runtime.RuleOutput rule3(java.lang.Number numberA, com.gs.dmn.runtime.ExecutionContext context_) {
        // Rule metadata
    ...
    public com.gs.dmn.runtime.RuleOutput rule4(java.lang.Number numberA, com.gs.dmn.runtime.ExecutionContext context_) {
        // Rule metadata
    ...
    public com.gs.dmn.runtime.RuleOutput rule5(java.lang.Number numberA, com.gs.dmn.runtime.ExecutionContext context_) {
        // Rule metadata
