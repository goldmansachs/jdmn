...
@javax.annotation.Generated(value = {"inputElement.ftl", "makeCreditDecision"})
@com.fasterxml.jackson.annotation.JsonPropertyOrder(alphabetic = true)
public class MakeCreditDecisionInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    private type.Applicant applicant;
    private java.lang.Number currentRiskAppetite;
    private java.lang.Number lendingThreshold;

    public MakeCreditDecisionInput_() {
    }
