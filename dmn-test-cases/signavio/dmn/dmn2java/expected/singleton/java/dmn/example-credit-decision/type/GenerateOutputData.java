...
public interface GenerateOutputData extends com.gs.dmn.runtime.DMNType {
    static GenerateOutputData toGenerateOutputData(Object other) {
        if (other == null) {
            ...
            Object decision = ((com.gs.dmn.runtime.Context)other).get("decision", "Decision");
            result_.setDecision((String)decision);
            Object assessment = ((com.gs.dmn.runtime.Context)other).get("assessment", "Assessment");
            result_.setAssessment((java.lang.Number)assessment);
            Object issue = ((com.gs.dmn.runtime.Context)other).get("issue", "Issue");
            result_.setIssue((java.lang.Number)issue);
            return result_;
