...
public class C extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public String apply(String modela_a, String modelb_a, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
    ...
    public String apply(String modela_a, String modelb_a, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_, com.gs.dmn.runtime.cache.Cache cache_) {
        try {
            ...
            // Evaluate decision 'c'
            String output_ = evaluate(modela_a, modelb_a, annotationSet_, eventListener_, externalExecutor_, cache_);
    ...
    protected String evaluate(String modela_a, String modelb_a, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_, com.gs.dmn.runtime.cache.Cache cache_) {
