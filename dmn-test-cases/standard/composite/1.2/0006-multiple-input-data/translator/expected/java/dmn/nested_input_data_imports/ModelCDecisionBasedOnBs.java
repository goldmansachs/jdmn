...
public class ModelCDecisionBasedOnBs extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public String apply(String modelb2_modela_personName, String modelb_modela_personName, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
    ...
    public String apply(String modelb2_modela_personName, String modelb_modela_personName, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_, com.gs.dmn.runtime.cache.Cache cache_) {
        try {
            ...
            String output_ = evaluate(modelb2_evaluatingB2SayHello, modelb_evaluatingSayHello, annotationSet_, eventListener_, externalExecutor_, cache_);
    ...
    protected String evaluate(String modelb2_evaluatingB2SayHello, String modelb_evaluatingSayHello, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_, com.gs.dmn.runtime.listener.EventListener eventListener_, com.gs.dmn.runtime.external.ExternalFunctionExecutor externalExecutor_, com.gs.dmn.runtime.cache.Cache cache_) {
