...
public class EvaluatingB2SayHello extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((EvaluatingB2SayHelloInput_)input_).getModel_a_personName(), context_);
        } catch (Exception e) {
    ...
    public String apply(String model_a_personName, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            evaluatingB2SayHelloArguments_.put("http://www.trisotech.com/definitions/_ae5b3c17-1ac3-4e1d-b4f9-2cf861aec6d9#Person name", model_a_personName);
    ...
    public com.gs.dmn.runtime.LambdaExpression<String> lambda =
        new com.gs.dmn.runtime.LambdaExpression<String>() {
            public String apply(Object... args_) {
                ...
                String model_a_greetThePerson = EvaluatingB2SayHello.this.model_a_greetThePerson.apply(model_a_personName, context_);
