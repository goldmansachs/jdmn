...
@javax.annotation.Generated(value = {"elementInput.ftl", "evaluatingB2SayHello"})
...
public class EvaluatingB2SayHelloInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public EvaluatingB2SayHelloInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
            Object model_a_personName = input_.get("http://www.provider.com/definitions/model-a#personName");
