...
public class PriceInRange extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public String apply(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("decisionInputs1.numB"), input_.get("decisionInputs1.numC"), input_.get("decisionInputs1.structA"), context_.getAnnotations(), context_.getEventListener(), context_.getExternalFunctionExecutor(), context_.getCache());
        } catch (Exception e) {
