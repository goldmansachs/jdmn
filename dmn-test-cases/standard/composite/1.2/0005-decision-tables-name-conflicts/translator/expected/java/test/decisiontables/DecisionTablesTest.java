...
public class DecisionTablesTest extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public void testCase001() {
        ...
        // Check priceGt10
        checkValues(Boolean.TRUE, new decisiontables.PriceGt10().apply(decisioninputs1_structA, annotationSet_, eventListener_, externalExecutor_, cache_));
    }
    ...
    public void testCase003() {
        ...
        // Check dateCompare1
        checkValues(Boolean.TRUE, new decisiontables.DateCompare1().apply(decisioninputs1_dateD, annotationSet_, eventListener_, externalExecutor_, cache_));
    }
    ...
    public void testCase004() {
        ...
        // Check dateCompare2
        checkValues(Boolean.FALSE, new decisiontables.DateCompare2().apply(decisioninputs1_dateD, decisioninputs2_dateD, annotationSet_, eventListener_, externalExecutor_, cache_));
    }
