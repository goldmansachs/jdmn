...
public class DateCompare1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Boolean> {
    ...
    public Boolean applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("http://www.provider.com/definitions/decision-inputs-1#dateD") != null ? date(input_.get("http://www.provider.com/definitions/decision-inputs-1#dateD")) : null), context_);
        } catch (Exception e) {
    ...
    public Boolean applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((DateCompare1Input_)input_).getDecisioninputs1_dateD(), context_);
        } catch (Exception e) {
    ...
    public Boolean apply(java.time.LocalDate decisioninputs1_dateD, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            Boolean output_ = lambda.apply(decisioninputs1_dateD, context_);
    ...
    public com.gs.dmn.runtime.LambdaExpression<Boolean> lambda =
        new com.gs.dmn.runtime.LambdaExpression<Boolean>() {
            public Boolean apply(Object... args_) {
                ...
                ruleOutputList_.add(rule0(decisioninputs1_dateD, context_));
                ruleOutputList_.add(rule1(decisioninputs1_dateD, context_));
