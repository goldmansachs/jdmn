...
public class DateCompare2 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Boolean> {
    ...
    public Boolean applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("http://www.provider.com/definitions/decision-inputs-1#dateD") != null ? date(input_.get("http://www.provider.com/definitions/decision-inputs-1#dateD")) : null), (input_.get("http://www.provider.com/definitions/decision-inputs-2#dateD") != null ? date(input_.get("http://www.provider.com/definitions/decision-inputs-2#dateD")) : null), context_);
        } catch (Exception e) {
    ...
    public Boolean apply(java.time.LocalDate decisioninputs1_dateD, java.time.LocalDate decisioninputs2_dateD, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            dateCompare2Arguments_.put("http://www.provider.com/definitions/decision-inputs-1#dateD", decisioninputs1_dateD);
            dateCompare2Arguments_.put("http://www.provider.com/definitions/decision-inputs-2#dateD", decisioninputs2_dateD);
