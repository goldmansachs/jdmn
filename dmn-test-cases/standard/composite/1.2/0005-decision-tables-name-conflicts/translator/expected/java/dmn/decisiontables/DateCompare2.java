...
public class DateCompare2 extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public Boolean apply(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("decisionInputs1.dateD"), input_.get("decisionInputs2.dateD"), context_.getAnnotations(), context_.getEventListener(), context_.getExternalFunctionExecutor(), context_.getCache());
        } catch (Exception e) {
    ...
    public com.gs.dmn.runtime.LambdaExpression<Boolean> lambda =
        new com.gs.dmn.runtime.LambdaExpression<Boolean>() {
            public Boolean apply(Object... args_) {
                ...
                ruleOutputList_.add(rule0(decisioninputs1_dateD, decisioninputs2_dateD, annotationSet_, eventListener_, externalExecutor_, cache_));
                ruleOutputList_.add(rule1(decisioninputs1_dateD, decisioninputs2_dateD, annotationSet_, eventListener_, externalExecutor_, cache_));
