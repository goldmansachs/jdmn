...
public class C extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((CInput_)input_).getModel_a_a(), ((CInput_)input_).getModel_b_a(), context_);
        } catch (Exception e) {
    ...
    public String apply(String model_a_a, String model_b_a, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            cArguments_.put("http://www.provider.com/definitions/model-a#a", model_a_a);
            cArguments_.put("http://www.provider.com/definitions/model-b#a", model_b_a);
