...
public class DateCompare1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Boolean> {
    ...
    public Boolean applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("http://www.provider.com/definitions/decision-inputs#dateD") != null ? date(input_.get("http://www.provider.com/definitions/decision-inputs#dateD")) : null), context_);
        } catch (Exception e) {
    ...
    public Boolean applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((DateCompare1Input_)input_).getDecisioninputs_dateD(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DateCompare1'", e);
            return null;
        }
    }
    ...
    public Boolean applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new DateCompare1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DateCompare1'", e);
            return null;
        }
    ...
    public Boolean apply(java.time.LocalDate decisioninputs_dateD, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            dateCompare1Arguments_.put("http://www.provider.com/definitions/decision-inputs#dateD", decisioninputs_dateD);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, dateCompare1Arguments_);

            // Evaluate decision 'dateCompare1'
            Boolean output_ = lambda.apply(decisioninputs_dateD, context_);
    ...
    public com.gs.dmn.runtime.LambdaExpression<Boolean> lambda =
        new com.gs.dmn.runtime.LambdaExpression<Boolean>() {
            public Boolean apply(Object... args_) {
                ...
                ruleOutputList_.add(rule0(decisioninputs_dateD, context_));
                ruleOutputList_.add(rule1(decisioninputs_dateD, context_));
