...
public class DateCompare2 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Boolean> {
    ...
    public Boolean applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("http://www.provider.com/definitions/decision-inputs#dateD") != null ? date(input_.get("http://www.provider.com/definitions/decision-inputs#dateD")) : null), (input_.get("http://www.provider.com/definitions/decision-inputs#dateE") != null ? date(input_.get("http://www.provider.com/definitions/decision-inputs#dateE")) : null), context_);
        } catch (Exception e) {
    ...
    public Boolean apply(java.time.LocalDate decisioninputs_dateD, java.time.LocalDate decisioninputs_dateE, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            dateCompare2Arguments_.put("http://www.provider.com/definitions/decision-inputs#dateD", decisioninputs_dateD);
            dateCompare2Arguments_.put("http://www.provider.com/definitions/decision-inputs#dateE", decisioninputs_dateE);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, dateCompare2Arguments_);

            // Evaluate decision 'dateCompare2'
            Boolean output_ = lambda.apply(decisioninputs_dateD, decisioninputs_dateE, context_);
    ...
    public com.gs.dmn.runtime.LambdaExpression<Boolean> lambda =
        new com.gs.dmn.runtime.LambdaExpression<Boolean>() {
            public Boolean apply(Object... args_) {
                ...
                ruleOutputList_.add(rule0(decisioninputs_dateD, decisioninputs_dateE, context_));
                ruleOutputList_.add(rule1(decisioninputs_dateD, decisioninputs_dateE, context_));
