...
public class PriceInRange extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((PriceInRangeInput_)input_).getDecisioninputs_numB(), ((PriceInRangeInput_)input_).getDecisioninputs_numC(), ((PriceInRangeInput_)input_).getDecisioninputs_structA(), context_);
        } catch (Exception e) {
    ...
    public String apply(java.lang.Number decisioninputs_numB, java.lang.Number decisioninputs_numC, decisioninputs.type.TA decisioninputs_structA, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            priceInRangeArguments_.put("http://www.provider.com/definitions/decision-inputs#numB", decisioninputs_numB);
            priceInRangeArguments_.put("http://www.provider.com/definitions/decision-inputs#numC", decisioninputs_numC);
            priceInRangeArguments_.put("http://www.provider.com/definitions/decision-inputs#structA", decisioninputs_structA);
