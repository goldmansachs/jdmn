...
public class _0089ModelCTest01Test extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Object> {
    ...
    @com.gs.dmn.runtime.annotation.TestCase(id = "001", resultNode = "c")
    public void testCase001_1() {
        ...
        input_.add("http://www.provider.com/definitions/model-c#aa", aa);
        input_.add("http://www.provider.com/definitions/model-c#ba", ba);
        ...
        checkValues("AA: 1000; BA: $", new C().applyContext(input_, context_));
    }
