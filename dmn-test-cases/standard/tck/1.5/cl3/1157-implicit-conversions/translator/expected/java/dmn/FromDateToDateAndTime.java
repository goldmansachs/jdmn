...
public class FromDateToDateAndTime extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.time.temporal.TemporalAccessor> {
    ...
    public java.time.temporal.TemporalAccessor applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new FromDateToDateAndTimeInput_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'FromDateToDateAndTime'", e);
            return null;
        }
