...
@jakarta.annotation.Generated(value = {"decision.ftl", "decision4"})
    ...
    public com.gs.dmn.runtime.LambdaExpression<String> lambda =
        new com.gs.dmn.runtime.LambdaExpression<String>() {
            public String apply(Object... args_) {
                ...
                return asElement(employees.stream().filter(item -> stringEqual(item, "Bob") == Boolean.TRUE).collect(Collectors.toList()));
            }
        };
}
