...
class Decision5() : com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String?>() {
    ...
    fun apply(employees: List<String?>?, context_: com.gs.dmn.runtime.ExecutionContext): String? {
        try {
            ...
            decision5Arguments_.put("http://www.trisotech.com/definitions/_f52ca843-504b-4c3b-a6bc-4d377bffef7a#Employees", employees)
