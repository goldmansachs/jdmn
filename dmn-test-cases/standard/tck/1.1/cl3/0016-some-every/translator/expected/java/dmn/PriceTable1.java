...
public class PriceTable1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<List<type.TItemPrice>> {
    ...
    @java.lang.Override()
    public List<type.TItemPrice> applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(context_);
        } catch (Exception e) {
            logError("Cannot apply element 'PriceTable1'", e);
            return null;
        }
    }

    @java.lang.Override()
    public List<type.TItemPrice> applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new PriceTable1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'PriceTable1'", e);
            return null;
        }
