...
class ExtraDaysCase2() : com.gs.dmn.runtime.JavaTimeDMNBaseDecision<kotlin.Number?>() {
    ...
    private inline fun evaluate(age: kotlin.Number?, yearsOfService: kotlin.Number?, context_: com.gs.dmn.runtime.ExecutionContext): kotlin.Number? {
        ...
        if (ruleOutputList_.noMatchedRules()) {
            ...
            output_ = max(ruleOutputs_?.map({ x_ -> (x_ as ExtraDaysCase2RuleOutput)?.extraDaysCase2 }))
        }
