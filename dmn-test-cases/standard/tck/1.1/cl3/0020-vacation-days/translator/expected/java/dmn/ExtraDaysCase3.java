...
public class ExtraDaysCase3 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.lang.Number> {
    ...
    public java.lang.Number applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((ExtraDaysCase3Input_)input_).getAge(), ((ExtraDaysCase3Input_)input_).getYearsOfService(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'ExtraDaysCase3'", e);
            return null;
        }
    }
    ...
    public java.lang.Number applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new ExtraDaysCase3Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'ExtraDaysCase3'", e);
            return null;
        }
