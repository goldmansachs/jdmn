...
public class ExtraDaysCase2 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.lang.Number> {
    ...
    public java.lang.Number applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((ExtraDaysCase2Input_)input_).getAge(), ((ExtraDaysCase2Input_)input_).getYearsOfService(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'ExtraDaysCase2'", e);
            return null;
        }
    }
    ...
    public java.lang.Number applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new ExtraDaysCase2Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'ExtraDaysCase2'", e);
            return null;
        }
    ...
    public java.lang.Number apply(java.lang.Number age, java.lang.Number yearsOfService, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            extraDaysCase2Arguments_.put("https://www.drools.org/kie-dmn#Age", age);
            extraDaysCase2Arguments_.put("https://www.drools.org/kie-dmn#Years of Service", yearsOfService);
        ...
        new com.gs.dmn.runtime.LambdaExpression<java.lang.Number>() {
            public java.lang.Number apply(Object... args_) {
                ...
                if (ruleOutputList_.noMatchedRules()) {
                    ...
                    output_ = max(ruleOutputs_.stream().map(x_ -> ((ExtraDaysCase2RuleOutput)x_).getExtraDaysCase2()).collect(Collectors.toList()));
                }
