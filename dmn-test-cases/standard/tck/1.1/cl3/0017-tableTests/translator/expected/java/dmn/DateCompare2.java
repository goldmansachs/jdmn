...
public class DateCompare2 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Boolean> {
    public static final com.gs.dmn.runtime.listener.DRGElement DRG_ELEMENT_METADATA = new com.gs.dmn.runtime.listener.DRGElement(
        "http://www.trisotech.com/definitions/_92a0c25f-707e-4fc8-ae2d-2ab51ebe6bb6",
        "dateCompare2",
        "",
    ...
    public Boolean applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("http://www.trisotech.com/definitions/_92a0c25f-707e-4fc8-ae2d-2ab51ebe6bb6#dateD") != null ? date(input_.get("http://www.trisotech.com/definitions/_92a0c25f-707e-4fc8-ae2d-2ab51ebe6bb6#dateD")) : null), (input_.get("http://www.trisotech.com/definitions/_92a0c25f-707e-4fc8-ae2d-2ab51ebe6bb6#dateE") != null ? date(input_.get("http://www.trisotech.com/definitions/_92a0c25f-707e-4fc8-ae2d-2ab51ebe6bb6#dateE")) : null), context_);
        } catch (Exception e) {
    ...
    public Boolean applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((DateCompare2Input_)input_).getDateD(), ((DateCompare2Input_)input_).getDateE(), context_);
        } catch (Exception e) {
    ...
    public Boolean applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new DateCompare2Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DateCompare2'", e);
            return null;
        }
    ...
    public Boolean apply(java.time.LocalDate dateD, java.time.LocalDate dateE, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
    ...
    public com.gs.dmn.runtime.LambdaExpression<Boolean> lambda =
        new com.gs.dmn.runtime.LambdaExpression<Boolean>() {
            public Boolean apply(Object... args_) {
                ...
                java.time.LocalDate dateE = 1 < args_.length ? (java.time.LocalDate) args_[1] : null;
    ...
    public com.gs.dmn.runtime.RuleOutput rule0(java.time.LocalDate dateD, java.time.LocalDate dateE, com.gs.dmn.runtime.ExecutionContext context_) {
        // Rule metadata
    ...
    public com.gs.dmn.runtime.RuleOutput rule1(java.time.LocalDate dateD, java.time.LocalDate dateE, com.gs.dmn.runtime.ExecutionContext context_) {
        // Rule metadata
