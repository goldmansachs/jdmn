...
@com.gs.dmn.runtime.annotation.TestCases(
    testCasesName = "",
    modelName = "0005-literal-invocation.dmn"
)
public class _0005LiteralInvocationTest01Test extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Object> {
    private static final com.gs.dmn.runtime.coverage.trace.CoverageTraceListener listener = new com.gs.dmn.runtime.coverage.trace.CoverageTraceListener("http://www.trisotech.com/definitions/_cb28c255-91cd-4c01-ac7b-1a9cb1ecdb11", "0005-literal-invocation", 2);

    @org.junit.jupiter.api.Test
    @com.gs.dmn.runtime.annotation.TestCase(id = "001", resultNode = "MonthlyPayment")
    ...
    @org.junit.jupiter.api.Test
    @com.gs.dmn.runtime.annotation.TestCase(id = "002", resultNode = "MonthlyPayment")
    ...
    @org.junit.jupiter.api.Test
    @com.gs.dmn.runtime.annotation.TestCase(id = "003", resultNode = "MonthlyPayment")
    ...
    static void saveTrace() {
        ...
        java.io.File traceFile = new java.io.File(traceDir, "0005-literal-invocation-test-01.json");
