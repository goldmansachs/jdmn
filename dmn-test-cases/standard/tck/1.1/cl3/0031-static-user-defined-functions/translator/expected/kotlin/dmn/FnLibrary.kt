...
class FnLibrary() : com.gs.dmn.runtime.JavaTimeDMNBaseDecision() {
    ...
    private inline fun evaluate(context_: com.gs.dmn.runtime.ExecutionContext): type.TFnLibrary? {
        ...
        var externalExecutor_: com.gs.dmn.runtime.external.ExternalFunctionExecutor = context_.getExternalFunctionExecutor()
        var cache_: com.gs.dmn.runtime.cache.Cache = context_.getCache()
        val sumFn: com.gs.dmn.runtime.LambdaExpression<java.lang.Number?>? = com.gs.dmn.runtime.LambdaExpression<java.lang.Number> { args_ -> val a: java.lang.Number? = args_[0] as java.lang.Number?; val b: java.lang.Number? = args_[1] as java.lang.Number?; numericAdd(a, b) } as com.gs.dmn.runtime.LambdaExpression<java.lang.Number?>?
        val subFn: com.gs.dmn.runtime.LambdaExpression<java.lang.Number?>? = com.gs.dmn.runtime.LambdaExpression<java.lang.Number> { args_ -> val a: java.lang.Number? = args_[0] as java.lang.Number?; val b: java.lang.Number? = args_[1] as java.lang.Number?; numericSubtract(a, b) } as com.gs.dmn.runtime.LambdaExpression<java.lang.Number?>?
        val multiplyFn: com.gs.dmn.runtime.LambdaExpression<java.lang.Number?>? = com.gs.dmn.runtime.LambdaExpression<java.lang.Number> { args_ -> val a: java.lang.Number? = args_[0] as java.lang.Number?; val b: java.lang.Number? = args_[1] as java.lang.Number?; numericMultiply(a, b) } as com.gs.dmn.runtime.LambdaExpression<java.lang.Number?>?
        val divideFn: com.gs.dmn.runtime.LambdaExpression<java.lang.Number?>? = com.gs.dmn.runtime.LambdaExpression<java.lang.Number> { args_ -> val a: java.lang.Number? = args_[0] as java.lang.Number?; val b: java.lang.Number? = args_[1] as java.lang.Number?; (if (booleanEqual(numericEqual(b, number("0")), true)) null else numericDivide(a, b)) } as com.gs.dmn.runtime.LambdaExpression<java.lang.Number?>?
