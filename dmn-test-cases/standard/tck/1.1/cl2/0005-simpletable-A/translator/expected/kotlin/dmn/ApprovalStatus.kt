...
class ApprovalStatus() : com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String?>() {
    override fun applyMap(input_: MutableMap<String, String>, context_: com.gs.dmn.runtime.ExecutionContext): String? {
        try {
            return apply(input_.get("http://www.trisotech.com/definitions/_6cb03678-38e5-4ee3-826b-d6622c738563#Age")?.let({ number(it) }), input_.get("http://www.trisotech.com/definitions/_6cb03678-38e5-4ee3-826b-d6622c738563#RiskCategory"), input_.get("http://www.trisotech.com/definitions/_6cb03678-38e5-4ee3-826b-d6622c738563#isAffordable")?.let({ it.toBoolean() }), context_)
        } catch (e: Exception) {
    ...
    fun apply(age: kotlin.Number?, riskCategory: String?, isAffordable: Boolean?, context_: com.gs.dmn.runtime.ExecutionContext): String? {
        try {
    ...
    private inline fun evaluate(age: kotlin.Number?, riskCategory: String?, isAffordable: Boolean?, context_: com.gs.dmn.runtime.ExecutionContext): String? {
        var annotationSet_: com.gs.dmn.runtime.annotation.AnnotationSet = context_.getAnnotations()
        var eventListener_: com.gs.dmn.runtime.listener.EventListener = context_.getEventListener()
        var externalExecutor_: com.gs.dmn.runtime.external.ExternalFunctionExecutor = context_.getExternalFunctionExecutor()
        var cache_: com.gs.dmn.runtime.cache.Cache = context_.getCache()
