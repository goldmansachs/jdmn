...
public class ApprovalStatusInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public ApprovalStatusInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
            Object age = input_.get("http://www.trisotech.com/definitions/_6cb03678-38e5-4ee3-826b-d6622c738563#Age");
            setAge((java.lang.Number)age);
            Object riskCategory = input_.get("http://www.trisotech.com/definitions/_6cb03678-38e5-4ee3-826b-d6622c738563#RiskCategory");
            setRiskCategory((String)riskCategory);
            Object isAffordable = input_.get("http://www.trisotech.com/definitions/_6cb03678-38e5-4ee3-826b-d6622c738563#isAffordable");
