...
public class Approval extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public com.gs.dmn.runtime.LambdaExpression<type.TApproval> lambda =
        new com.gs.dmn.runtime.LambdaExpression<type.TApproval>() {
            public type.TApproval apply(Object... args) {
                java.math.BigDecimal age = 0 < args.length ? (java.math.BigDecimal) args[0] : null;
                String riskCategory = 1 < args.length ? (String) args[1] : null;
                Boolean isAffordable = 2 < args.length ? (Boolean) args[2] : null;
