...
public class Bkm_008_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<com.gs.dmn.runtime.LambdaExpression<java.lang.Number>> {
    ...
    public com.gs.dmn.runtime.LambdaExpression<java.lang.Number> applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((Bkm_008_1Input_)input_).getA(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Bkm_008_1'", e);
            return null;
        }
    }
    ...
    public com.gs.dmn.runtime.LambdaExpression<java.lang.Number> applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Bkm_008_1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Bkm_008_1'", e);
            return null;
        }
