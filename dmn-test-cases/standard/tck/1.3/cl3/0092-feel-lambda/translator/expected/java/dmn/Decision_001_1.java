...
@javax.annotation.Generated(value = {"decision.ftl", "decision_001_1"})
...
public class Decision_001_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.lang.Number> {
    ...
    public java.lang.Number applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            logError("Cannot apply element 'Decision_001_1'", e);
            return null;
        }
    }
    ...
    public java.lang.Number applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Decision_001_1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_001_1'", e);
            return null;
        }
    ...
    public com.gs.dmn.runtime.LambdaExpression<java.lang.Number> lambda =
        new com.gs.dmn.runtime.LambdaExpression<java.lang.Number>() {
            public java.lang.Number apply(Object... args_) {
                ...
                com.gs.dmn.runtime.LambdaExpression<java.lang.Number> decision_001_2 = Decision_001_1.this.decision_001_2.apply(context_);
