...
public class Decision_013_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.lang.Number> {
    ...
    public com.gs.dmn.runtime.LambdaExpression<java.lang.Number> lambda =
        new com.gs.dmn.runtime.LambdaExpression<java.lang.Number>() {
            public java.lang.Number apply(Object... args_) {
                ...
                return Bkm_013_1.instance().apply(DecisionService_013_1.instance().lambda, DecisionService_013_1.instance().lambda, context_);
            }
        };
}
