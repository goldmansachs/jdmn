...
public class Decision_017_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<List<String>> {
    ...
    public List<String> applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((Decision_017_1Input_)input_).getInput_017_1(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_017_1'", e);
            return null;
        }
    }
    ...
    public List<String> applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Decision_017_1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_017_1'", e);
            return null;
        }
