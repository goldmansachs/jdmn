...
public class DecisionService_013_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.lang.Number> {
    ...
    public java.lang.Number applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new DecisionService_013_1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DecisionService_013_1'", e);
            return null;
        }
    ...
    public java.lang.Number apply(java.lang.Number input_013_1, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionService_013_1Arguments_.put("http://www.montera.com.au/spec/DMN/0092-feel-lambda#input_013_1", input_013_1);
