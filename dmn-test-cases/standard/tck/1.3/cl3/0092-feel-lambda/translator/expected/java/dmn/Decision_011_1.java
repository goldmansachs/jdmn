...
public class Decision_011_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.lang.Number> {
    ...
    public java.lang.Number applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("http://www.montera.com.au/spec/DMN/0092-feel-lambda#input_011_1") != null ? number(input_.get("http://www.montera.com.au/spec/DMN/0092-feel-lambda#input_011_1")) : null), context_);
        } catch (Exception e) {
    ...
    public java.lang.Number applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((Decision_011_1Input_)input_).getInput_011_1(), context_);
        } catch (Exception e) {
    ...
    public java.lang.Number applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Decision_011_1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_011_1'", e);
            return null;
        }
    ...
    public java.lang.Number apply(java.lang.Number input_011_1, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decision_011_1Arguments_.put("http://www.montera.com.au/spec/DMN/0092-feel-lambda#input_011_1", input_011_1);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decision_011_1Arguments_);

            // Evaluate decision 'decision_011_1'
            java.lang.Number output_ = lambda.apply(input_011_1, context_);
    ...
    public com.gs.dmn.runtime.LambdaExpression<java.lang.Number> lambda =
        new com.gs.dmn.runtime.LambdaExpression<java.lang.Number>() {
            public java.lang.Number apply(Object... args_) {
                java.lang.Number input_011_1 = 0 < args_.length ? (java.lang.Number) args_[0] : null;
                ...
                return Bkm_011_1.instance().apply(new com.gs.dmn.runtime.LambdaExpression<java.lang.Number>() {public java.lang.Number apply(Object... args_) {java.lang.Number a = (java.lang.Number)args_[0];return numericMultiply(input_011_1, a);}}, new com.gs.dmn.runtime.LambdaExpression<java.lang.Number>() {public java.lang.Number apply(Object... args_) {java.lang.Number b = (java.lang.Number)args_[0];return numericMultiply(input_011_1, b);}}, context_);
            }
        };
}
