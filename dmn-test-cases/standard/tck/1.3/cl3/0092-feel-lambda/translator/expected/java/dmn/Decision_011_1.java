...
public class Decision_011_1 extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public java.math.BigDecimal apply(String input_011_1, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        try {
            return apply((input_011_1 != null ? number(input_011_1) : null), annotationSet_, new com.gs.dmn.runtime.listener.LoggingEventListener(LOGGER), new com.gs.dmn.runtime.external.DefaultExternalFunctionExecutor(), new com.gs.dmn.runtime.cache.DefaultCache());
        } catch (Exception e) {
    ...
    public java.math.BigDecimal apply(java.math.BigDecimal input_011_1, com.gs.dmn.runtime.annotation.AnnotationSet annotationSet_) {
        return apply(input_011_1, annotationSet_, new com.gs.dmn.runtime.listener.LoggingEventListener(LOGGER), new com.gs.dmn.runtime.external.DefaultExternalFunctionExecutor(), new com.gs.dmn.runtime.cache.DefaultCache());
    }
    ...
    public com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal> lambda =
        new com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>() {
            public java.math.BigDecimal apply(Object... args) {
                java.math.BigDecimal input_011_1 = 0 < args.length ? (java.math.BigDecimal) args[0] : null;
                ...
                return Bkm_011_1.instance().apply(new com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>() {public java.math.BigDecimal apply(Object... args) {java.math.BigDecimal a = (java.math.BigDecimal)args[0];return numericMultiply(input_011_1, a);}}, new com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>() {public java.math.BigDecimal apply(Object... args) {java.math.BigDecimal b = (java.math.BigDecimal)args[0];return numericMultiply(input_011_1, b);}}, annotationSet_, eventListener_, externalExecutor_, cache_);
            }
        };
}
