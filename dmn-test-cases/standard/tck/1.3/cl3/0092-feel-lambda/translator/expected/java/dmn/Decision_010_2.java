...
public class Decision_010_2 extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public com.gs.dmn.runtime.LambdaExpression<com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>> lambda =
        new com.gs.dmn.runtime.LambdaExpression<com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal>>() {
            public com.gs.dmn.runtime.LambdaExpression<java.math.BigDecimal> apply(Object... args) {
                ...
                return Bkm_010_1.instance().apply(number("2"), annotationSet_, eventListener_, externalExecutor_, cache_).apply(number("3"), annotationSet_, eventListener_, externalExecutor_, cache_).apply(number("4"), annotationSet_, eventListener_, externalExecutor_, cache_);
            }
        };
}
