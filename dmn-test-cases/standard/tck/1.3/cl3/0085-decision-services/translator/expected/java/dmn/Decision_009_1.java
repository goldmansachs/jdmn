...
public class Decision_009_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            logError("Cannot apply element 'Decision_009_1'", e);
            return null;
        }
    }
    ...
    public String applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Decision_009_1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_009_1'", e);
            return null;
        }
    ...
    public com.gs.dmn.runtime.LambdaExpression<String> lambda =
        new com.gs.dmn.runtime.LambdaExpression<String>() {
            public String apply(Object... args_) {
                ...
                return DecisionService_009.instance().apply("bar", context_);
            }
        };
}
