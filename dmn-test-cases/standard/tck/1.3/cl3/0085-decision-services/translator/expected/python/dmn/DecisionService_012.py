...
class DecisionService_012(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, inputData_012_1: typing.Optional[str], inputData_012_2: typing.Optional[str], decision_012_3: typing.Optional[str], decision_012_4: typing.Optional[str], context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        try:
            ...
            output_: typing.Optional[str] = self.evaluate(inputData_012_1, inputData_012_2, decision_012_3, decision_012_4, context_)
    ...
    def evaluate(self, inputData_012_1: typing.Optional[str], inputData_012_2: typing.Optional[str], decision_012_3: typing.Optional[str], decision_012_4: typing.Optional[str], context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        # Apply child decisions
        decision_012_2: typing.Optional[str] = self.decision_012_2.apply(inputData_012_1, inputData_012_2, context_)
