...
# Generated(value = ["decision.ftl", "decision_012_4"])
class Decision_012_4(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        try:
            ...
            decision_012_4StartTime_ = int(time.time_ns()/1000)
            decision_012_4Arguments_ = jdmn.runtime.listener.Arguments.Arguments()
            eventListener_.startDRGElement(self.DRG_ELEMENT_METADATA, decision_012_4Arguments_)

            if cache_.contains("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_012_4"):
                # Retrieve value from cache
                output_: typing.Optional[str] = cache_.lookup("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_012_4")

                # End decision 'decision_012_4'
                eventListener_.endDRGElement(self.DRG_ELEMENT_METADATA, decision_012_4Arguments_, output_, (int(time.time_ns()/1000) - decision_012_4StartTime_))

                return output_
            else:
                # Evaluate decision 'decision_012_4'
                output_: typing.Optional[str] = self.evaluate(context_)
                cache_.bind("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_012_4", output_)
            ...
            self.logError("Exception caught in 'decision_012_4' evaluation", e)
            return None
