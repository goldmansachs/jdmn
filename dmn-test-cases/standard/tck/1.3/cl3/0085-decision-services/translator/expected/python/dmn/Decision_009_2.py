...
import Decision_009_3


# Generated(value = ["decision.ftl", "decision_009_2"])
class Decision_009_2(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def __init__(self, decision_009_3: Decision_009_3.Decision_009_3 = None):
        jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision.__init__(self)
        self.decision_009_3 = Decision_009_3.Decision_009_3() if decision_009_3 is None else decision_009_3
    ...
    def apply(self, annotationSet_: jdmn.runtime.annotation.AnnotationSet.AnnotationSet, eventListener_: jdmn.runtime.listener.EventListener.EventListener, externalExecutor_: jdmn.runtime.external.ExternalFunctionExecutor.ExternalFunctionExecutor, cache_: jdmn.runtime.cache.Cache.Cache) -> typing.Optional[str]:
        try:
            ...
            decision_009_2StartTime_ = int(time.time_ns()/1000)
            decision_009_2Arguments_ = jdmn.runtime.listener.Arguments.Arguments()
            eventListener_.startDRGElement(self.DRG_ELEMENT_METADATA, decision_009_2Arguments_)
            ...
            eventListener_.endDRGElement(self.DRG_ELEMENT_METADATA, decision_009_2Arguments_, output_, (int(time.time_ns()/1000) - decision_009_2StartTime_))

            return output_
        except Exception as e:
            self.logError("Exception caught in 'decision_009_2' evaluation", e)
            return None
    ...
    def evaluate(self, annotationSet_: jdmn.runtime.annotation.AnnotationSet.AnnotationSet, eventListener_: jdmn.runtime.listener.EventListener.EventListener, externalExecutor_: jdmn.runtime.external.ExternalFunctionExecutor.ExternalFunctionExecutor, cache_: jdmn.runtime.cache.Cache.Cache) -> typing.Optional[str]:
        ...
        decision_009_3: typing.Optional[str] = self.decision_009_3.apply(annotationSet_, eventListener_, externalExecutor_, cache_)

        return self.stringAdd("foo ", decision_009_3)
