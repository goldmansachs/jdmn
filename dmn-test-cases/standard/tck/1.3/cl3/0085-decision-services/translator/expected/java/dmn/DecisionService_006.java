...
public class DecisionService_006 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_006_3"), context_);
        } catch (Exception e) {
    ...
    public String apply(String decision_006_3, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionService_006Arguments_.put("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_006_3", decision_006_3);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decisionService_006Arguments_);

            // Bind input decisions
            cache_.bind("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_006_3", decision_006_3);
