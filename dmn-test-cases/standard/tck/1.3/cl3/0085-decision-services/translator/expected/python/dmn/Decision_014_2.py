...
class Decision_014_2(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, inputData_014_1: typing.Optional[str], context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        try:
            ...
            decision_014_2Arguments_.put("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_014_1", inputData_014_1)
            eventListener_.startDRGElement(self.DRG_ELEMENT_METADATA, decision_014_2Arguments_)

            # Evaluate decision 'decision_014_2'
            output_: typing.Optional[str] = self.evaluate(inputData_014_1, context_)
    ...
    def evaluate(self, inputData_014_1: typing.Optional[str], context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
