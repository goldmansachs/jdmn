...
public class Decision_003_input_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            logError("Cannot apply element 'Decision_003_input_1'", e);
            return null;
        }
    }
    ...
    public String applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Decision_003_input_1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_003_input_1'", e);
            return null;
        }
    ...
    public String apply(com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            if (cache_.contains("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_003_input_1")) {
                ...
                String output_ = (String)cache_.lookup("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_003_input_1");
