...
# Generated(value = ["decision.ftl", "decision_011_3"])
class Decision_011_3(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        try:
            ...
            decision_011_3StartTime_ = int(time.time_ns()/1000)
            decision_011_3Arguments_ = jdmn.runtime.listener.Arguments.Arguments()
            eventListener_.startDRGElement(self.DRG_ELEMENT_METADATA, decision_011_3Arguments_)

            if cache_.contains("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_011_3"):
                # Retrieve value from cache
                output_: typing.Optional[str] = cache_.lookup("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_011_3")

                # End decision 'decision_011_3'
                eventListener_.endDRGElement(self.DRG_ELEMENT_METADATA, decision_011_3Arguments_, output_, (int(time.time_ns()/1000) - decision_011_3StartTime_))

                return output_
            else:
                # Evaluate decision 'decision_011_3'
                output_: typing.Optional[str] = self.evaluate(context_)
                cache_.bind("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_011_3", output_)
            ...
            self.logError("Exception caught in 'decision_011_3' evaluation", e)
            return None
