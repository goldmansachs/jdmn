...
# Generated(value = ["decision.ftl", "decision_015_1"])
class Decision_015_1(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        try:
            ...
            decision_015_1StartTime_ = int(time.time_ns()/1000)
            decision_015_1Arguments_ = jdmn.runtime.listener.Arguments.Arguments()
            eventListener_.startDRGElement(self.DRG_ELEMENT_METADATA, decision_015_1Arguments_)

            # Evaluate decision 'decision_015_1'
            output_: typing.Optional[str] = self.evaluate(context_)

            # End decision 'decision_015_1'
            eventListener_.endDRGElement(self.DRG_ELEMENT_METADATA, decision_015_1Arguments_, output_, (int(time.time_ns()/1000) - decision_015_1StartTime_))

            return output_
        except Exception as e:
            self.logError("Exception caught in 'decision_015_1' evaluation", e)
            return None
