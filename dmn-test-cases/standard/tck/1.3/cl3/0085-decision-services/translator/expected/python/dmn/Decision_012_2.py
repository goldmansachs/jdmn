...
class Decision_012_2(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, inputData_012_1: typing.Optional[str], inputData_012_2: typing.Optional[str], context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        try:
            ...
            decision_012_2Arguments_.put("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_012_1", inputData_012_1)
            decision_012_2Arguments_.put("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_012_2", inputData_012_2)
            eventListener_.startDRGElement(self.DRG_ELEMENT_METADATA, decision_012_2Arguments_)

            # Evaluate decision 'decision_012_2'
            output_: typing.Optional[str] = self.evaluate(inputData_012_1, inputData_012_2, context_)
    ...
    def evaluate(self, inputData_012_1: typing.Optional[str], inputData_012_2: typing.Optional[str], context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        # Apply child decisions
        decision_012_3: typing.Optional[str] = self.decision_012_3.apply(context_)
        decision_012_4: typing.Optional[str] = self.decision_012_4.apply(context_)
