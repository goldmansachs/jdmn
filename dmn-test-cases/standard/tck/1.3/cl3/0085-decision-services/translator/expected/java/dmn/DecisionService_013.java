...
public class DecisionService_013 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_013_1"), input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_013_3"), context_);
        } catch (Exception e) {
    ...
    public String applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((DecisionService_013Input_)input_).getInputData_013_1(), ((DecisionService_013Input_)input_).getDecision_013_3(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DecisionService_013'", e);
            return null;
        }
    }
    ...
    public String applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new DecisionService_013Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DecisionService_013'", e);
            return null;
        }
