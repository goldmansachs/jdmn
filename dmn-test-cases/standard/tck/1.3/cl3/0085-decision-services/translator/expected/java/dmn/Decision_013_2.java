...
public class Decision_013_2 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_013_1"), context_);
        } catch (Exception e) {
    ...
    public String apply(String inputData_013_1, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decision_013_2Arguments_.put("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_013_1", inputData_013_1);
