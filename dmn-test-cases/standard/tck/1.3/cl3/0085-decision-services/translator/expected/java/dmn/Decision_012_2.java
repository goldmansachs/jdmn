...
public class Decision_012_2 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_012_1"), input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_012_2"), context_);
        } catch (Exception e) {
    ...
    public String applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((Decision_012_2Input_)input_).getInputData_012_1(), ((Decision_012_2Input_)input_).getInputData_012_2(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_012_2'", e);
            return null;
        }
    }
    ...
    public String applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Decision_012_2Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_012_2'", e);
            return null;
        }
