...
public class DecisionService_012 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_012_1"), input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_012_2"), input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_012_3"), input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_012_4"), context_);
        } catch (Exception e) {
    ...
    public String applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((DecisionService_012Input_)input_).getInputData_012_1(), ((DecisionService_012Input_)input_).getInputData_012_2(), ((DecisionService_012Input_)input_).getDecision_012_3(), ((DecisionService_012Input_)input_).getDecision_012_4(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DecisionService_012'", e);
            return null;
        }
    }
    ...
    public String applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new DecisionService_012Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DecisionService_012'", e);
            return null;
        }
