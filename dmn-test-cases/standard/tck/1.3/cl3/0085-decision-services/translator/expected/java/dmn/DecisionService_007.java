...
public class DecisionService_007 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Boolean> {
    ...
    public Boolean applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_007_3"), context_);
        } catch (Exception e) {
    ...
    public Boolean applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new DecisionService_007Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DecisionService_007'", e);
            return null;
        }
    ...
    public Boolean apply(String decision_007_3, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decisionService_007Arguments_.put("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_007_3", decision_007_3);
            eventListener_.startDRGElement(DRG_ELEMENT_METADATA, decisionService_007Arguments_);

            // Bind input decisions
            cache_.bind("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_007_3", decision_007_3);
