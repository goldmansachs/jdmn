...
import DecisionService_004


# Generated(value = ["decision.ftl", "decision_004_1"])
class Decision_004_1(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, annotationSet_: jdmn.runtime.annotation.AnnotationSet.AnnotationSet, eventListener_: jdmn.runtime.listener.EventListener.EventListener, externalExecutor_: jdmn.runtime.external.ExternalFunctionExecutor.ExternalFunctionExecutor, cache_: jdmn.runtime.cache.Cache.Cache) -> typing.Optional[str]:
        try:
            ...
            decision_004_1StartTime_ = int(time.time_ns()/1000)
            decision_004_1Arguments_ = jdmn.runtime.listener.Arguments.Arguments()
            eventListener_.startDRGElement(self.DRG_ELEMENT_METADATA, decision_004_1Arguments_)
            ...
            eventListener_.endDRGElement(self.DRG_ELEMENT_METADATA, decision_004_1Arguments_, output_, (int(time.time_ns()/1000) - decision_004_1StartTime_))

            return output_
        except Exception as e:
            self.logError("Exception caught in 'decision_004_1' evaluation", e)
            return None
    ...
    def evaluate(self, annotationSet_: jdmn.runtime.annotation.AnnotationSet.AnnotationSet, eventListener_: jdmn.runtime.listener.EventListener.EventListener, externalExecutor_: jdmn.runtime.external.ExternalFunctionExecutor.ExternalFunctionExecutor, cache_: jdmn.runtime.cache.Cache.Cache) -> typing.Optional[str]:
        return DecisionService_004.DecisionService_004.instance().apply(annotationSet_, eventListener_, externalExecutor_, cache_)
