...
# Generated(value = ["decision.ftl", "decision_015_2"])
class Decision_015_2(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        try:
            ...
            decision_015_2StartTime_ = int(time.time_ns()/1000)
            decision_015_2Arguments_ = jdmn.runtime.listener.Arguments.Arguments()
            eventListener_.startDRGElement(self.DRG_ELEMENT_METADATA, decision_015_2Arguments_)

            # Evaluate decision 'decision_015_2'
            output_: typing.Optional[str] = self.evaluate(context_)

            # End decision 'decision_015_2'
            eventListener_.endDRGElement(self.DRG_ELEMENT_METADATA, decision_015_2Arguments_, output_, (int(time.time_ns()/1000) - decision_015_2StartTime_))

            return output_
        except Exception as e:
            self.logError("Exception caught in 'decision_015_2' evaluation", e)
            return None
