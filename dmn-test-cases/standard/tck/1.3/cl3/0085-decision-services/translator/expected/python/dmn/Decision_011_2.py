...
class Decision_011_2(jdmn.runtime.DefaultDMNBaseDecision.DefaultDMNBaseDecision):
    ...
    def apply(self, inputData_011_1: typing.Optional[str], inputData_011_2: typing.Optional[str], context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        try:
            ...
            output_: typing.Optional[str] = self.evaluate(inputData_011_1, inputData_011_2, context_)
    ...
    def evaluate(self, inputData_011_1: typing.Optional[str], inputData_011_2: typing.Optional[str], context_: jdmn.runtime.ExecutionContext.ExecutionContext) -> typing.Optional[str]:
        # Apply child decisions
        decision_011_3: typing.Optional[str] = self.decision_011_3.apply(context_)
        decision_011_4: typing.Optional[str] = self.decision_011_4.apply(context_)
