...
public class DecisionService_014 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_014_1"), input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#decision_014_3"), context_);
        } catch (Exception e) {
    ...
    public String applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new DecisionService_014Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'DecisionService_014'", e);
            return null;
        }
