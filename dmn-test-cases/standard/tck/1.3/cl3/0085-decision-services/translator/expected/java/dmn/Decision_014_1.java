...
public class Decision_014_1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<com.gs.dmn.runtime.Context> {
    ...
    public com.gs.dmn.runtime.Context applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(input_.get("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_014_1"), context_);
        } catch (Exception e) {
    ...
    public com.gs.dmn.runtime.Context applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((Decision_014_1Input_)input_).getInputData_014_1(), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_014_1'", e);
            return null;
        }
    }
    ...
    public com.gs.dmn.runtime.Context applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Decision_014_1Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Decision_014_1'", e);
            return null;
        }
    ...
    public com.gs.dmn.runtime.Context apply(String inputData_014_1, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decision_014_1Arguments_.put("http://www.montera.com.au/spec/DMN/0085-decision-services#inputData_014_1", inputData_014_1);
