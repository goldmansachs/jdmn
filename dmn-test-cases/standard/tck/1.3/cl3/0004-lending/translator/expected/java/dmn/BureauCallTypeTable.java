...
public class BureauCallTypeTable extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<String> {
    ...
    public String applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new BureauCallTypeTableInput_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'BureauCallTypeTable'", e);
            return null;
        }
