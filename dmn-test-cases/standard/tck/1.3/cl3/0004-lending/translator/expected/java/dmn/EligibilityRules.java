    ...
    public com.gs.dmn.runtime.LambdaExpression<String> lambda =
        new com.gs.dmn.runtime.LambdaExpression<String>() {
            public String apply(Object... args) {
                String preBureauRiskCategory = 0 < args.length ? (String) args[0] : null;
                Boolean preBureauAffordability = 1 < args.length ? (Boolean) args[1] : null;
                java.math.BigDecimal age = 2 < args.length ? (java.math.BigDecimal) args[2] : null;
