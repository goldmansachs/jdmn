...
@javax.annotation.Generated(value = {"elementInput.ftl", "Adjudication"})
...
public class AdjudicationInput_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public AdjudicationInput_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
            ...
            Object supportingDocuments = input_.get("http://www.trisotech.com/definitions/_4e0f0b70-d31c-471c-bd52-5ca709ed362b#SupportingDocuments");
