...
/**
 * Handler for requests to Lambda function for element ''Extra days case 3'' in model '0020-vacation-days'.
 */
public class ExtraDaysCase3Lambda implements com.amazonaws.services.lambda.runtime.RequestHandler<Map<String, String>, Object> {
    private final ExtraDaysCase3 extraDaysCase3 = new ExtraDaysCase3();
    ...
    public Object handleRequest(Map<String, String> event_, com.amazonaws.services.lambda.runtime.Context context_) {
        ...
        java.math.BigDecimal output_ = extraDaysCase3.apply(age, yearsOfService, annotationSet_, eventListener_, externalExecutor_, cache_);

        java.util.Map<String, Object> result_ = new java.util.LinkedHashMap<>();
        result_.put("'Extra days case 3'", output_);
        if (trace_) {
