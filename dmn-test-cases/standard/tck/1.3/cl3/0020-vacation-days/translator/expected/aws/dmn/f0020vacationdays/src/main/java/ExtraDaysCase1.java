...
public class ExtraDaysCase1 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.lang.Number> {
    ...
    public java.lang.Number applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply(((ExtraDaysCase1Input_)input_).getAge(), ((ExtraDaysCase1Input_)input_).getYearsOfService(), context_);
        } catch (Exception e) {
        ...
        new com.gs.dmn.runtime.LambdaExpression<java.lang.Number>() {
            public java.lang.Number apply(Object... args_) {
                ...
                if (ruleOutputList_.noMatchedRules()) {
                    ...
                    output_ = max(ruleOutputs_.stream().map(x_ -> ((ExtraDaysCase1RuleOutput)x_).getExtraDaysCase1()).collect(Collectors.toList()));
                }
