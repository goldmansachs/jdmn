...
public class Endswith_002 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<Boolean> {
    ...
    public Boolean applyPojo(com.gs.dmn.runtime.ExecutableDRGElementInput input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            logError("Cannot apply element 'Endswith_002'", e);
            return null;
        }
    }
    ...
    public Boolean applyContext(com.gs.dmn.runtime.Context input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return applyPojo(new Endswith_002Input_(input_), context_);
        } catch (Exception e) {
            logError("Cannot apply element 'Endswith_002'", e);
            return null;
        }
