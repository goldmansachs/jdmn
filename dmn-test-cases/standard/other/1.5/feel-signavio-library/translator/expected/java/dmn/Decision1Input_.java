...
@javax.annotation.Generated(value = {"elementInput.ftl", "Decision1"})
...
public class Decision1Input_ implements com.gs.dmn.runtime.ExecutableDRGElementInput {
    ...
    public Decision1Input_(com.gs.dmn.runtime.Context input_) {
        if (input_ != null) {
            Object inputString = input_.get("http://www.montera.com.au/spec/DMN/feel-signavio-library#inputString");
