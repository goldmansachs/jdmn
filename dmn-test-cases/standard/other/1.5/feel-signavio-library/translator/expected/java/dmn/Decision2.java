...
public class Decision2 extends com.gs.dmn.runtime.JavaTimeDMNBaseDecision<java.lang.Number> {
    ...
    public java.lang.Number applyMap(java.util.Map<String, String> input_, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            return apply((input_.get("http://www.montera.com.au/spec/DMN/feel-signavio-library#inputDate") != null ? date(input_.get("http://www.montera.com.au/spec/DMN/feel-signavio-library#inputDate")) : null), context_);
        } catch (Exception e) {
    ...
    public java.lang.Number apply(java.time.LocalDate inputDate, com.gs.dmn.runtime.ExecutionContext context_) {
        try {
            ...
            decision2Arguments_.put("http://www.montera.com.au/spec/DMN/feel-signavio-library#inputDate", inputDate);
