...
public class TestLabToKotlinJUnitMojo<NUMBER, DATE, TIME, DATE_TIME, DURATION> extends AbstractDMNMojo<NUMBER, DATE, TIME, DATE_TIME, DURATION, TestLab> {
    ...
    protected FileTransformer makeTransformer(com.gs.dmn.log.BuildLogger logger) throws Exception {
        ...
        FileTransformer transformer = new TestLabToKotlinJUnitTransformer<>(
                dmnDialect,
                dmnValidator,
                dmnTransformer,
                templateProvider,
                ...
                this.inputModelFileDirectory.toPath(), this.
                inputParameters,
                logger
        );
        return transformer;
