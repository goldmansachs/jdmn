...
public class TCKToPythonJUnitMojoTest<NUMBER, DATE, TIME, DATE_TIME, DURATION> extends AbstractDMNMojoTest<NUMBER, DATE, TIME, DATE_TIME, DURATION, TestCases> {
    @Test
    public void testExecute() throws Exception {
        TCKToPythonJUnitMojo<NUMBER, DATE, TIME, DATE_TIME, DURATION> mojo = getMojo();
    ...
    @Override
    protected TCKToPythonJUnitMojo<NUMBER, DATE, TIME, DATE_TIME, DURATION> getMojo() {
        return new TCKToPythonJUnitMojo<>();
    }
}