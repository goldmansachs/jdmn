...
public class TestLabToJavaJUnitMojoTest<NUMBER, DATE, TIME, DATE_TIME, DURATION> extends AbstractDMNMojoTest<NUMBER, DATE, TIME, DATE_TIME, DURATION, TestLab> {
    @Test
    public void testExecute() throws Exception {
        TestLabToJavaJUnitMojo<NUMBER, DATE, TIME, DATE_TIME, DURATION> mojo = getMojo();
    ...
    @Override
    protected TestLabToJavaJUnitMojo<NUMBER, DATE, TIME, DATE_TIME, DURATION> getMojo() {
        return new TestLabToJavaJUnitMojo<>();
    }
}