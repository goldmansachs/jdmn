...
public class DMNToPythonMojoTest<NUMBER, DATE, TIME, DATE_TIME, DURATION, TEST> extends AbstractDMNMojoTest<NUMBER, DATE, TIME, DATE_TIME, DURATION, TEST> {
    ...
    public void testExecute() throws Exception {
        DMNToPythonMojo<NUMBER, DATE, TIME, DATE_TIME, DURATION, TEST> mojo = getMojo();
    ...
    @Override
    protected DMNToPythonMojo<NUMBER, DATE, TIME, DATE_TIME, DURATION, TEST> getMojo() {
        return new DMNToPythonMojo<>();
    }
}