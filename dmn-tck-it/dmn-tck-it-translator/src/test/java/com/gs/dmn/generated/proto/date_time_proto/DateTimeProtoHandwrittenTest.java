...
public class DateTimeProtoHandwrittenTest extends com.gs.dmn.runtime.DefaultDMNBaseDecision {
    ...
    public void testCase2() {
        ...
        checkValues("12:10:10", new Time().apply(timeRequest_, annotationSet_, eventListener_, externalExecutor_, cache_).getTime());
    }
    ...
    public void testCase3() {
        ...
        checkValues("2020-09-19T12:10:10", new DateTime().apply(dateTimeRequest_, annotationSet_, eventListener_, externalExecutor_, cache_).getDateTime());
    }
